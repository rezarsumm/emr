...
public function cetak_asesmen_awal_medis($FS_KD_REG = "",$FS_FORM="") {
  ...
  // $data["rs_ases_medis"]=$this->m_cppt->get_data_medis_by_rg(array($FS_KD_REG));
   ...
   try {
    ...
    public function cetak_lap_op2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
    ...
    // $data["rs_ases_medis"]=$this->m_cppt->get_data_medis_by_rg(array($FS_KD_REG));
        ...
        $now = date('Y-m-d');
            $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_lap_op"] = $this->m_cppt->get_list_op_by_rg3(array($id));
            
            
    
        ob_start();
        $this->load->view('rm/rawat_inap/laporan_operasi2', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_rencana_medis_post_op2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
    ...
    // $data["rs_ases_medis"]=$this->m_cppt->get_data_medis_by_rg(array($FS_KD_REG));
        ...
        $now = date('Y-m-d');
            $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_pasca_op3"] = $this->m_cppt->get_list_pasca_op_by_rg3($id);
            
       
        ob_start();
        $this->load->view('rm/rawat_inap/rencana_post_op', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_lap_anes2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
    ...
    // $data["rs_ases_medis"]=$this->m_cppt->get_data_medis_by_rg(array($FS_KD_REG));
        ...
        $now = date('Y-m-d');
            ...
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_lap_op"] = $this->m_cppt->get_list_op_by_rg(array($FS_KD_REG));
            $data["rs_lap_anes"] = $this->m_cppt->get_list_lap_anes_by_rg3(array($id));
            $data["data_operasi"] = $this->m_cppt->data_operasi(array($id));
           
              $data["rs_file_rr"]= $this->m_cppt->get_rr_by_id(array($id));  
               $data["catatan_rr"]= $this->m_cppt->catatan_rr(array($id));
          $data["rs_file_anes"]= $this->m_cppt->get_progress_by_id(array($id));       
    
        ob_start();
        $this->load->view('rm/rawat_inap/laporan_anes2', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_data_umum_pra2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
        ...
        $now = date('Y-m-d');
            $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_op"] = $this->m_cppt->get_data_jadwal_op_by_id(array($id));
            $data["rs_umum_pra"] = $this->m_cppt->get_list_umum_pra_by_rg3($id);
            
            
    
        ob_start();
        $this->load->view('rm/rawat_inap/data_umum_pra2', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_data_umum_post2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
        ...
        $now = date('Y-m-d');
            ...
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_lap_op"] = $this->m_cppt->get_list_op_by_rg(array($FS_KD_REG));
            $data["rs_lap_anes3"] = $this->m_cppt->get_list_lap_anes_by_rg3($id);
            $data["rs_umum_post"] = $this->m_cppt->get_list_umum_post_by_rg3($id);
            
        
        ob_start();
        $this->load->view('rm/rawat_inap/data_umum_post2', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_alat_habis_pakai($FS_KD_REG = "",$id="") {
        ...
        $now = date('Y-m-d');
            $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_lap_op"] = $this->m_cppt->get_list_op_by_rg3($id);
            $data["rs_lap_anes"] = $this->m_cppt->get_list_lap_anes_by_rg3($id);
    ...
    public function cetak_alat_habis_pakai2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
        ...
        $now = date('Y-m-d');
            $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_lap_op"] = $this->m_cppt->get_list_op_by_rg10($id);
             $data["alat"] = $this->m_cppt->alat2(array($FS_KD_REG,$id));
            $data["rs_umum_post"] = $this->m_cppt->get_list_umum_post_by_rg(array($FS_KD_REG));
    ...
    public function cetak_checklist2($FS_KD_REG = "",$idoperasi="") {
        $this->_set_page_rule("R");
        ...
        $now = date('Y-m-d');
            $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
            $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
            $data["rs_sign_in"] = $this->m_cppt->get_list_sign_in_by_rg4(array($idoperasi));
            $data["rs_umum_pra"] = $this->m_cppt->get_list_umum_pra_by_rg(array($FS_KD_REG));
            
        
            $idchecklist=$this->m_cppt->get_id_operasi3($idoperasi);
            $idchecklist=$idchecklist['id'];

            $data["bendatajam"] = $this->m_cppt->get_list_benda_tajam_by_rg(array($idchecklist));
            
    
        ob_start();
        $this->load->view('rm/rawat_inap/checklist_keselamatan2', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_asuhan_kep_op($FS_KD_REG = "",$id="") {
        ...
        $now = date('Y-m-d');
            ...
            $data["rs_sign_in"] = $this->m_cppt->get_list_sign_in_by_rg(array($FS_KD_REG));
            $data["rs_umum_pra"] = $this->m_cppt->get_list_umum_pra_by_rg(array($FS_KD_REG));
            $data["rs_asuhan"] = $this->m_cppt->get_list_asuhan_all_op2_by_rg(array($FS_KD_REG, $id));
    ...
    public function cetak_asuhan_kep_op2($FS_KD_REG = "",$id="") {
        $this->_set_page_rule("R");
        ...
        ob_start();
        $this->load->view('rm/rawat_inap/asuhan_keperawatan_op2', $data);
        $content = ob_get_contents();
        ob_end_clean();
 ...
 public function cetak_ases_pra_bedah2($FS_KD_REG = "",$id="") {
    $this->_set_page_rule("R");
   ...
   // $data["rs_ases_medis"]=$this->m_cppt->get_data_medis_by_rg(array($FS_KD_REG));
    ...
    $now = date('Y-m-d');
         $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
        $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
        $data["rs_pra"] = $this->m_cppt->get_list_pra_op_by_rg3(array($id));
        
        
 
    ob_start();
    $this->load->view('rm/rawat_inap/ases_pra_bedah2', $data);
    $content = ob_get_contents();
    ob_end_clean();
 ...
 public function cetak_ases_pra_anes2($FS_KD_REG = "",$id="") {
    $this->_set_page_rule("R");
   ...
   // $data["rs_ases_medis"]=$this->m_cppt->get_data_medis_by_rg(array($FS_KD_REG));
    ...
    $now = date('Y-m-d');
         $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($FS_KD_REG));
        $data["vs"] = $this->m_rawat_jalan->get_data_vs_by_rg(array($FS_KD_REG));
        $data["rs_pra_anes"] = $this->m_cppt->get_list_pra_anes_by_rg3(array($id));
        
        
 
    ob_start();
    $this->load->view('rm/rawat_inap/ases_pra_anes2', $data);
    $content = ob_get_contents();
    ob_end_clean();
