...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2"> <br><br>Bahwa pasien tersebut membutuhkan Konsultasi dengan alasan:</td>
    ...
    <table class="content">
        ...
        <tr>
            ...
            <td></td>
            <td align='center'>
                <qrcode value="<?= $rs_skdp['FS_NM_PEG']; ?> pada <?= $result['mdd']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
            ...
            <page orientation="P" backtop="1mm" backbottom="10mm" backleft="15mm" backright="10mm">
                ...
                <table class="content">
                    ...
                    <tr>
                        <td></td>
                        <td align='center'>
                    <qrcode value="<?= $rs_pasien['FS_NM_PEG']; ?> pada <?= $result['mdd']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
                    <br>
                    </td>
                    </tr>
                    <tr>
