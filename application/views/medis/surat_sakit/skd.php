...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        <tbody>
            ...
            <tr>
                ...
                <br> No: <?= $ket_skd['NO_SURAT'];?>/SKD/III.5.AU/<?= date('Y');?>
    ...
    <br> <br>
    Yang bertanda tangan dibawah ini, Dokter <?= $ket_skd['NAMA_DOKTER'];?>, menerangkan dengan mengingat Sumpah/Perjanjian sewaktu menerima jabatan, bahwa :
...
<br>
   ...
   Hasil pemeriksaan yang dilakukan meliputi :
    <br>
    Berat Badan : <?= $ket_skd['FS_BB'];?> Kg.  Tinggi Badan : <?= $ket_skd['FS_TB'];?> cm.
