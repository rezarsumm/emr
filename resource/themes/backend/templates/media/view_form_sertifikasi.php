...
<div class="box box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">Input Sertifikasi</h3>
    </div>

    <div class="box-body">
    	<?php 
		$hidden_form = array("inputAwardId" => $editdata['awardId'],"inputTypeAward" => $editdata['awardType']);
		echo form_open_multipart("media/admin/sertifikasi/save", array("method" => "post","id" => "formInputAward", "class" => "form-horizontal"), $hidden_form); 
		?>
