<?php /* Smarty version Smarty-3.0.7, created on 2021-03-10 10:42:52
         compiled from "application/views\settings/user/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:135546048403cb1be40-19261463%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '135546048403cb1be40-19261463',
  'function' => 
  array (
  ),
...
" />
    <table class="table-input" width="100%">
        ...
        <tr>
            ...
            <td width="75%"><?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FS_NM_PEG'])===null||$tmp==='' ? '' : $tmp);?>
</td>
        </tr>
        <tr>
            <td>Alamat *</td>
            <td><?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FS_ALM_PEG'])===null||$tmp==='' ? '' : $tmp);?>
</td>
        </tr>
        <tr>
            <td>Email *</td>
            <td><?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FS_EMAIL'])===null||$tmp==='' ? '' : $tmp);?>
</td>
        </tr>
        <tr>
            <td>Nomor Telepon *</td>
            <td><?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FS_HP_PEG'])===null||$tmp==='' ? '' : $tmp);?>
</td>
        </tr>
        <tr>
