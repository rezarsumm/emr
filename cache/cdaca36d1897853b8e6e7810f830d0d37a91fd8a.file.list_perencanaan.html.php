<?php /* Smarty version Smarty-3.0.7, created on 2021-12-06 14:36:08
         compiled from "application/views\pengaturan/kep/list_perencanaan.html" */ ?>
<?php /*%%SmartyHeaderCode:1202561adbd68d138f8-04562507%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdaca36d1897853b8e6e7810f830d0d37a91fd8a' => 
    array (
      0 => 'application/views\\pengaturan/kep/list_perencanaan.html',
      1 => 1616210792,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1202561adbd68d138f8-04562507',
  'function' => 
  array (
  ),
...
<div class="content-entry">
    <div class="navigation">
        <div class="navigation-button">
            <ul>
                <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('pengaturan/kep/add_perencanaan');?>
...
resource/doc/images/icon/add-icon.png" alt="" /> Add Data</a></li>
 ...
 $_from = $_smarty_tpl->getVariable('rs_perencanaan')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
<br>
            ...
            <td align="center">
                <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url((($tmp = @('pengaturan/kep/edit_perencanaan/').($_smarty_tpl->tpl_vars['result']->value['FS_KD_NIC']))===null||$tmp==='' ? '' : $tmp));?>
" class="button-edit">Edit</a>
                <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url((($tmp = @('pengaturan/kep/delete_perencanaan_process/').($_smarty_tpl->tpl_vars['result']->value['FS_KD_NIC']))===null||$tmp==='' ? '' : $tmp));?>
