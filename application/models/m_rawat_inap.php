...
class m_rawat_inap extends CI_Model {
    ...
    // }
      ...
      function get_px_by_dokter_by_rg2($params) {
        $sql = "SELECT A.NO_REG,A.NO_MR,A.TGL_MULAI,B.NAMA_PASIEN,A.KODE_RUANG, B.JENIS_KELAMIN,B.ALAMAT,D.KODE_BANGSAL,C.NAMA_RUANG,D.NAMA_BANGSAL,E.KODEREKANAN,F.NAMAREKANAN ,B.TGL_LAHIR,E.TANGGAL,E.JAM,datediff(year,B.TGL_LAHIR,GETDATE()) 'fn_umur', B.FS_ALERGI,B.FS_RIW_PENYAKIT_DAHULU,B.FS_RIW_PENYAKIT_DAHULU2
        FROM TR_KAMAR A, REGISTER_PASIEN B, M_RUANG C, M_BANGSAL D, PENDAFTARAN E, REKANAN F 
        WHERE  A.NO_MR=B.NO_MR AND A.NO_REG=E.NO_REG AND E.KODEREKANAN=F.KODEREKANAN 
