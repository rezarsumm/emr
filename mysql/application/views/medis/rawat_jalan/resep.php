    ...
    <page_footer>
        <table style="width: 80%; border-top: solid 1px black;font-size: 9px;">
            ...
            <tr>
                ...
                <td style="width: 30%;"> <?= $rs_pasien['MR']; ?> / <?= $rs_pasien['FS_KD_REG']; ?></td>
                <td style="width: 10%;">Tgl. Lahir </td>
                <td style="width: 30%;"><?= date('d-m-Y', strtotime($rs_pasien['FD_TGL_LAHIR'])); ?></td>
            </tr>
            <tr>
                <td>Nama </td>
                <td  colspan="2"><?= substr($rs_pasien['FS_NM_PASIEN'],0,25); ?></td>
            </tr>   

            <tr>
                <td>Alamat </td>
                <td colspan="2"><?= substr($rs_pasien['FS_ALM_PASIEN'],0,25); ?></td>
            </tr>
            <tr>
                <td>Jaminan </td>
                <td><?= substr($rs_pasien['FS_NM_JAMINAN'],0,25); ?></td>
                <td>Jenis Kelamin </td>
                <td><?php if($rs_pasien['FS_JNS_KELAMIN']=='1'){echo "Perempuan";}elseif($rs_pasien['FS_JNS_KELAMIN']=='0'){echo "Laki-Laki";} ?></td>
            </tr>       
            <tr>
                <td>TB </td>
            ...
            <tr>
             ...
             <tr>
                <td>SEP</td>
                <td><?= $rs_pasien['FS_NO_SJP']; ?></td>
                <td>Alergi</td>
                <td><?= $rs_pasien['FS_ALERGI2']; ?></td>
            </tr>   
             <tr>
                <td>No Kartu</td>
                <td><?= $rs_pasien['FS_NO_PESERTA']; ?></td>
                <td></td>
                <td>
