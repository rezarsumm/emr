...
//     }
    ...
    public function eksport() {
        ...
        foreach ($hata as $data) {
            ...
            $objWorksheet->setCellValue('F' . $i, $data['Kode_Datang']);
            ...
            $objWorksheet->setCellValue('J' . $i, rekanan($data['KodeRekanan']));
            $objWorksheet->setCellValue('K' . $i, strip_tags($data['FS_DIAGNOSA']));
