...
class navigation extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "pengaturan/role/access.html");
        // get data
    ...
    public function access_update($role_id) {
        ...
        // set template content
        $this->smarty->assign("template_content", "pengaturan/role/access_update.html");
        // get detail role
        $result = $this->m_settings->get_detail_role_by_id_as($role_id);
        if (!empty($result)) {
    ...
    private function _display_menu($portal_id, $role_id, $parent_id, $indent) {
        ...
        $rs_id = $this->m_settings->get_all_menu_selected_by_parent_as($params);
        if (!empty($rs_id)) {
            $no = 0;
            $indent .= "--- ";
    ...
    public function process() {
        ...
        // default redirect
        redirect("pengaturan/navigation/access_update/" . $this->input->post('role_id'));
    }
