   ...
   <page_header>
        <table class="page_header">
            ...
            <td  style="font-size: 9px">
                ...
                <hr>
                Tgl Masuk Rawat Inap : <?php echo date('d-m-Y', strtotime($rs_pasien['TANGGAL'])); ?>
            </td>
        </tr>
    </table>
    </page_header>
    ...
    <table class="content">
        <tbody>
            ...
            <tr>
                <td align="center">
                    <br><strong>HASIL PENUNJANG DIAGNOSIS</strong>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                <td style="border-bottom:solid 1px #000000;" colspan="3"><b>HASIL LABORATORIUM</b></td>
            </tr>
            <tr>
            ...
            <?php foreach ($rs_lab as $lab) {
                ...
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;text-align:left;border-right:solid 1px #000000;border-top:solid 1px #000000;"><?= $lab['Tanggal']; ?></td>
