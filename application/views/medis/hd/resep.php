...
<page format="200x100" orientation="P" style="font: arial;"  backtop="40mm" backbottom="10mm" backleft="2mm" backright="2mm">
    <page_header>
        <br><br><br><br><br><br>
    ...
    <page_footer>
        <table style="width: 100%; border-top: solid 1px black;font-size: 9px;">
            ...
            <tr>
                ...
                <td style="width: 40%;"><?= strip_tags($medis['FS_DIAGNOSA']); ?></td>
