<?php /* Smarty version Smarty-3.0.7, created on 2021-09-07 14:57:23
         compiled from "application/views\medis/rawat_jalan/add_prb.html" */ ?>
<?php /*%%SmartyHeaderCode:268861371b631fd4e9-96058037%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'df44aa261b9f469eaa996ec48ae2e849a128ff7b' => 
    array (
      0 => 'application/views\\medis/rawat_jalan/add_prb.html',
      1 => 1631000778,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '268861371b631fd4e9-96058037',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/rawat_jalan/add_prb_process');?>
" method="post">
...
<br> 2. <?php echo $_smarty_tpl->getVariable('result')->value['DOK2'];?>
    ...
    <table class="table-input" width="100%">
        <tr class="headrow">
            <th colspan="4">Rujuk Balik</th>
        </tr>
        <tr>
            <td width='15%'>Tanggal Kembali ke RS </td>
            <td width='85%'>
