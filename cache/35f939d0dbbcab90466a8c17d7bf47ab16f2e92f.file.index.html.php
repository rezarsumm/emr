<?php /* Smarty version Smarty-3.0.7, created on 2021-09-21 09:33:29
         compiled from "application/views\nurse/rawat_jalan_kb/index.html" */ ?>
<?php /*%%SmartyHeaderCode:37186073ad2e474569-39344662%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '37186073ad2e474569-39344662',
  'function' => 
  array (
  ),
...
resource/doc/images/icon/icon.waiting.farmasi.png" alt="" />
                    ...
                    <td>
                        ...
                        <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('nurse/rawat_jalan_kb/history/').($_smarty_tpl->tpl_vars['data']->value['NO_MR'])).('/')).($_smarty_tpl->getVariable('search')->value['FS_KD_PEG']));?>
...
', 'nama_window_pop_up', 'scrollbars=yes,resizeable=no')" class="button-edit">SKDP</a>
                        ...
                        <a  href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url((('rm/rawat_inap/cetak_rm/').($_smarty_tpl->tpl_vars['data']->value['NO_REG'])).('/11'));?>
