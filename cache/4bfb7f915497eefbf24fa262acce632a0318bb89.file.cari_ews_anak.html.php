<?php /* Smarty version Smarty-3.0.7, created on 2022-12-13 16:41:25
         compiled from "application/views\igd/cari_ews_anak.html" */ ?>
<?php /*%%SmartyHeaderCode:6333639848c538c504-53540368%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4bfb7f915497eefbf24fa262acce632a0318bb89' => 
    array (
      0 => 'application/views\\igd/cari_ews_anak.html',
      1 => 1658905938,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6333639848c538c504-53540368',
  'function' => 
  array (
  ),
...
<div class="head-content">
    <div class="head-content-nav">
        <!--<ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('igd/cppt/');?>
" class="active">Cari Data</a></li>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('igd/cppt/cari2');?>
">Cari History</a></li>
        </ul>-->
        <div class="clear"></div>
    </div>
...
<div class="content-entry">
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('igd/ews_anak/add');?>
" method="post">
