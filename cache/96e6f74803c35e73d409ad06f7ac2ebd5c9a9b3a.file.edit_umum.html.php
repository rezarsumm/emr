<?php /* Smarty version Smarty-3.0.7, created on 2022-03-07 09:48:09
         compiled from "application/views\medis/rawat_inap/edit_umum.html" */ ?>
<?php /*%%SmartyHeaderCode:1514062257269e9aea0-49383450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96e6f74803c35e73d409ad06f7ac2ebd5c9a9b3a' => 
    array (
      0 => 'application/views\\medis/rawat_inap/edit_umum.html',
      1 => 1646621225,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1514062257269e9aea0-49383450',
  'function' => 
  array (
  ),
...
<div class="breadcrum"> 
    <p>
        ...
        <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/rawat_inap/');?>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/rawat_inap/edit_process_umum');?>
...
" />
    ...
    <table class="table-info" width="100%">
     ...
     <table class="table-input" width="100%">
        ...
        <tr>  
            <td colspan="2">
                <textarea cols="80" rows="4" name="FS_ANAMNESA"><?php echo $_smarty_tpl->getVariable('result')->value['FS_ANAMNESA'];?>
</textarea>
            </td>
            <td colspan="2">
                <textarea cols="80"  rows="4" name="FS_CATATAN_FISIK"><?php echo $_smarty_tpl->getVariable('result')->value['FS_CATATAN_FISIK'];?>
</textarea>
...
" size="32">
        ...
        <tr>
            ...
            <td width='30%'>
                <input type="text" name="FS_ALERGI"   value="<?php echo $_smarty_tpl->getVariable('result')->value['FS_ALERGI'];?>
">
                <em style="color:red">* Wajib Diisi</em>
            </td>
            <td width='20%'>Reaksi Alergi</td>
            <td width='30%'>
                <input type="text" name="FS_REAK_ALERGI"  value="<?php echo $_smarty_tpl->getVariable('result')->value['FS_REAK_ALERGI'];?>
">
                <em style="color:red">* Wajib Diisi</em>
            </td>
        </tr>
...
">
        ...
        <tr>
            ...
            <td width='40%'>
                <input type="checkbox" name="KONJUNGTIVA" <?php if ($_smarty_tpl->getVariable('result')->value['KONJUNGTIVA']=='Pucat'){?> checked="" <?php }?> value="Pucat">Pucat
                <input type="checkbox" name="KONJUNGTIVA" <?php if ($_smarty_tpl->getVariable('result')->value['KONJUNGTIVA']=='Pink'){?> checked="" <?php }?> value="Pink">Pink
             </td>
            <td width='40%'>Deviasi Trakea  </td>
            <td width='40%'>
                <input type="checkbox" name="DEVIASI" <?php if ($_smarty_tpl->getVariable('result')->value['DEVIASI']=='Kanan'){?> checked="" <?php }?>  value="Kanan">Kanan
                <input type="checkbox" name="DEVIASI" <?php if ($_smarty_tpl->getVariable('result')->value['DEVIASI']=='Kiri'){?> checked="" <?php }?> value="Kiri"> Kiri
                <input type="checkbox" name="DEVIASI" <?php if ($_smarty_tpl->getVariable('result')->value['DEVIASI']==''){?> checked="" <?php }?> value=""> Tidak Ada
            </td>
         </tr>
         <tr>
            <td width='20%'>Skelera  </td>
            <td width='40%'>
                <input type="checkbox" name="SKELERA" <?php if ($_smarty_tpl->getVariable('result')->value['SKELERA']=='Ikterik'){?> checked="" <?php }?> value="Ikterik">Ikterik
                <input type="checkbox" name="SKELERA" <?php if ($_smarty_tpl->getVariable('result')->value['SKELERA']=='Tidak'){?> checked="" <?php }?> value="Tidak"> Tidak Ikterik
            </td>
            <td width='20%'>JVP  </td>
            <td width='40%'>
                <input type="checkbox" name="JVP" <?php if ($_smarty_tpl->getVariable('result')->value['JVP']=='Meningkat'){?> checked="" <?php }?>  value="Meningkat">Meningkat
                <input type="checkbox" name="JVP" <?php if ($_smarty_tpl->getVariable('result')->value['JVP']=='Tidak'){?> checked="" <?php }?>   value="Tidak"> Tidak 
            
         </tr>
         <tr>
            <td width='20%'>Bibir/Lidah  </td>
            <td width='40%'>
                <input type="checkbox" name="BIBIR" <?php if ($_smarty_tpl->getVariable('result')->value['BIBIR']=='Sianosis'){?> checked="" <?php }?>  value="Sianosis">Sianosis
                <input type="checkbox" name="BIBIR" <?php if ($_smarty_tpl->getVariable('result')->value['BIBIR']=='Tidak'){?> checked="" <?php }?>  value="Tidak"> Tidak
            </td>
         </tr>
         <tr>
            <td width='20%'>Mukosa </td>
            <td width='40%'>
                <input type="checkbox" name="MUKOSA" <?php if ($_smarty_tpl->getVariable('result')->value['MUKOSA']=='Kering'){?> checked="" <?php }?>  value="Sianosis">Kering
                <input type="checkbox" name="MUKOSA" <?php if ($_smarty_tpl->getVariable('result')->value['MUKOSA']=='Tidak'){?> checked="" <?php }?>  value="Tidak"> Basah
            </td>
         </tr>
        ...
        <tr>
            <td colspan="2">
                <textarea cols="80" rows="1" name="THORAX"> <?php echo $_smarty_tpl->getVariable('result')->value['THORAX'];?>
</textarea>
            </td>
            <td colspan="2">
                <textarea cols="80" rows="1" name="JANTUNG"><?php echo $_smarty_tpl->getVariable('result')->value['JANTUNG'];?>
</textarea>
        ...
        <tr>
            <td colspan="2">
                <textarea cols="80" rows="1" name="ABDOMEN"><?php echo $_smarty_tpl->getVariable('result')->value['ABDOMEN'];?>
 </textarea>
            </td>
            <td colspan="2">
                <textarea cols="80" rows="1" name="PINGGANG"> <?php echo $_smarty_tpl->getVariable('result')->value['PINGGANG'];?>
 </textarea>
        ...
        <tr>
            <td colspan="2"> Atas
                <textarea cols="80" rows="1" name="EKS_ATAS"><?php echo $_smarty_tpl->getVariable('result')->value['EKS_ATAS'];?>
 </textarea>
            </td>
            <td colspan="2">Bawah
                <textarea cols="80" rows="1" name="EKS_BAWAH"><?php echo $_smarty_tpl->getVariable('result')->value['EKS_BAWAH'];?>
 </textarea>
        ...
        <tr>
            <td colspan="2">
                <textarea cols="80" rows="4" name="FS_DAFTAR_MASALAH"><?php echo $_smarty_tpl->getVariable('result')->value['FS_DAFTAR_MASALAH'];?>
</textarea>
            </td>
            <td colspan="2">
                <textarea cols="80" rows="4" name="FS_TINDAKAN"><?php echo $_smarty_tpl->getVariable('result')->value['FS_TINDAKAN'];?>
</textarea>
        ...
        <tr>
            <td colspan="2">
                <?php if ($_smarty_tpl->getVariable('result')->value['FS_PLANNING_LAB']=='0'||$_smarty_tpl->getVariable('result')->value['FS_PLANNING_LAB']==''){?>
                <select name="FS_PLANNING_LAB[]" multiple id="rlab" style="width:350px">
                        <option></option>
                    </select> 
                    <?php }else{ ?>
                <textarea cols="80" name="FS_PLANNING_LAB"><?php echo $_smarty_tpl->getVariable('result')->value['FS_PLANNING_LAB'];?>
</textarea>
                <?php }?>
          <input type="hidden" value="<?php echo $_smarty_tpl->getVariable('result')->value['FS_PLANNING_LAB'];?>
" class="inilablama" >
            </td>
            <td colspan="2">
                 <?php if ($_smarty_tpl->getVariable('result')->value['FS_PLANNING_RAD']=='0'||$_smarty_tpl->getVariable('result')->value['FS_PLANNING_RAD']==''){?>
                  <select name="FS_PLANNING_RAD[]" multiple id="rrad" style="width:350px">
                        <option></option>
                    </select>  
                    <?php }else{ ?>
                <textarea cols="80" name="FS_PLANNING_RAD"><?php echo $_smarty_tpl->getVariable('result')->value['FS_PLANNING_RAD'];?>
</textarea>
                <?php }?>
...
" class="iniradlama" >
        ...
        <tr>
            <td colspan="2">
                    ...
                    <textarea rows="15" class="form-control resep"  cols="60" name="FS_TERAPI"> 
                        <?php echo $_smarty_tpl->getVariable('result')->value['FS_TERAPI'];?>
        ...
        <tr>
            ...
            <td colspan="2">
               <!--  <textarea cols="80" rows="8" name="FS_TERAPI"><?php echo $_smarty_tpl->getVariable('result')->value['FS_TERAPI'];?>
</textarea> -->
            ...
            <td colspan="2">
                 ...
                 <textarea rows="5" cols="80" name="FS_PESAN"><?php echo $_smarty_tpl->getVariable('result')->value['FS_PESAN'];?>
