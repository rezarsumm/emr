...
// output
    ...
    public function history($FS_MR = "",$FD_TGL_MASUK="") {
// set page rules
        $this->_set_page_rule("R");
// set template content
...
// get search parameter
        ...
        $this->smarty->assign("rs_pasien", $this->m_rawat_jalan->get_px_history_hd(array($FD_TGL_MASUK, $medis, $medis, $medis, $FS_MR)));
// notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
// output
