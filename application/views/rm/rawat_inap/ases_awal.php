    ...
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
             ...
             <tr>
                <td style="border-left:solid 1px #000000;"><b>Breathing</b></td>
                <td style="border-right:solid 1px #000000;"></td>
            </tr>
              <tr>
                <td style="border-left:solid 1px #000000;">Irama Nafas</td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['IRAMA_NAFAS'];?>  
                </td>
            </tr>
              ...
              <tr>
                <td style="border-left:solid 1px #000000;"> Pola pernafasan </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['POLA_NAFAS'];?>  
                </td>
            </tr>
              <tr>
                <td style="border-left:solid 1px #000000;">Suara Nafas</td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['SUARA_NAFAS'];?>  
                </td>
            </tr>
              ...
              <tr>
                <td style="border-left:solid 1px #000000;">Alat Bantu Nafas</td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['BANTU_NAFAS'];?>  
                </td>
            </tr>
             ...
             <tr>
                <td style="border-left:solid 1px #000000;"><b> Blood </b></td>
                <td style="border-right:solid 1px #000000;"></td>
            </tr> 
              <tr>
                <td style="border-left:solid 1px #000000;"> Nyeri dada </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['NYERI_DADA'];?>  
                </td>
            </tr>
             <tr>
                <td style="border-left:solid 1px #000000;"> Perdarahan </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['PERDARAHAN'];?>  
                </td>
            </tr>
             <tr>
                <td style="border-left:solid 1px #000000;"> Cyanosis </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['CYANOSIS'];?>  
                </td>
            </tr>
             <tr>
                <td style="border-left:solid 1px #000000;"> CRT </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['CRT'];?>  
                </td>
            </tr>
             <tr>
                <td style="border-left:solid 1px #000000;"> Turgor </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['TURGOR'];?>  
                </td>
            </tr>
              ...
              <tr>
                <td style="border-left:solid 1px #000000;"><b> Brain </b></td>
                <td style="border-right:solid 1px #000000;"></td>
            </tr>  
             <tr>
                <td style="border-left:solid 1px #000000;"> Reflek Cahaya </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['REFLEK_CAHAYA'];?>  
                </td>
            </tr>
              <tr>
                <td style="border-left:solid 1px #000000;"> PUPIL </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['Pupil'];?>  
                </td>
            </tr>
              <tr>
                <td style="border-left:solid 1px #000000;"> Kleumpuhan </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['LUMPUH'];?>  
                </td>
            </tr>
              <tr>
                <td style="border-left:solid 1px #000000;"> Pusing </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['PUSING'];?>  
                </td>
            </tr>
            <tr>
               <td style="border-left:solid 1px #000000;"><b> BAK </b></td>
                <td style="border-right:solid 1px #000000;"></td>
            </tr>  
             <tr>
                <td style="border-left:solid 1px #000000;"> BAK </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['BAK'];?>  
                </td>
            </tr> 
              <tr>
                <td style="border-left:solid 1px #000000;"> Nyeri Tekan </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['BAK_TEKAN'];?>  
                </td>
            </tr>
            <tr>
               <td style="border-left:solid 1px #000000;"> Produksi Urin </td>
                <td style="border-right:solid 1px #000000;">
                    : <?= $ases2['URINE'];?>  
                </td>
            </tr>
