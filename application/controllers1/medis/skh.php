...
class Skh extends ApplicationBase {
...
// set template content
        $this->smarty->assign("template_content", "medis/skh/index.html");
...
// get search parameter
        ...
        if($x=='216'|| $x=='217'|| $x=='215'|| $x=='213'|| $x=='202' || $x=='219' || $x=='220' || $x=='221' || $x=='312'){
...
// output
    ...
    public function create($FS_KD_REG = "") { 
        ...
        $ceksuratsakit = $this->m_rawat_jalan->cek_hpl(array($FS_KD_REG));

        if ($ceksuratsakit >= '1') {
           // set page rules
           $this->_set_page_rule("R");
           // set template content
                   $this->smarty->assign("template_content", "medis/skh/edit_suratsakit.html");
                   ...
                   $this->smarty->assign("ket_sakit", $this->m_rawat_jalan->data_surat_hamil(array($FS_KD_REG)));
           // notification
                   $this->tnotification->display_notification();
                   $this->tnotification->display_last_field();
           // output
        ...
        // set page rules
                $this->_set_page_rule("R");
        // set template content
                $this->smarty->assign("template_content", "medis/skh/create_suratsakit.html");
                $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                $this->smarty->load_javascript('resource/js/jquery/select2.js');
                $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
     ...
     public function simpan_suratsakit() {
                ...
                if ($this->tnotification->run() !== FALSE) {
                    ...
                    $params = array(
                     ...
                     if ($this->m_rawat_jalan->insert_surathamil($params)) {
            ...
            public function cetak($FS_KD_REG = "") {
               $this->_set_page_rule("R");
                ...
                $data['ket_sakit']= $this->m_rawat_jalan->data_surat_hamil(array($FS_KD_REG));
                 ob_start();
                $this->load->view('medis/skh/surathamil', $data);
            ...
            public function create_skd($FS_KD_REG = "") { 
                ...
                if ($cekskd >= '1') {
                   ...
                   $this->_set_page_rule("R");
                   // set template content
                           $this->smarty->assign("template_content", "medis/skh/edit_skd.html");
                           $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                           $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                           $this->smarty->load_javascript('resource/js/jquery/select2.js');
                           $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
                ...
                // set page rules
                        $this->_set_page_rule("R");
                // set template content
                        $this->smarty->assign("template_content", "medis/skh/create_skd.html");
                        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                        $this->smarty->load_javascript('resource/js/jquery/select2.js');
                        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
               ...
               public function update_suratsakit() {
                ...
                if ($this->tnotification->run() !== FALSE) {
                    ...
                    $params = array(
                     ...
                     if ($this->m_rawat_jalan->update_surathamil($params)) {
         ...
         public function update_skd() {
                    ...
                    public function cetak_skd($FS_KD_REG = "") {
                        ...
                        $data['ket_skd']= $this->m_rawat_jalan->data_skd(array($FS_KD_REG));
                         ob_start();
                        $this->load->view('medis/skh/skd', $data);
                        $content = ob_get_contents();
                        ob_end_clean();
