<?php /* Smarty version Smarty-3.0.7, created on 2022-07-25 09:03:38
         compiled from "application/views\nurse/rencana_op/index.html" */ ?>
<?php /*%%SmartyHeaderCode:1528262ddf9fa1f5296-85751360%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c230b7dfe9c220bd28762c06431d2090b9537496' => 
    array (
      0 => 'application/views\\nurse/rencana_op/index.html',
      1 => 1658109818,
      2 => 'file',
  ...
  'nocache_hash' => '1528262ddf9fa1f5296-85751360',
  'function' => 
  array (
  ),
...
<a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('nurse/rencana_op/add');?>
">
...
?>
            <tr>
                ...
                <td>
                    <?php if ($_smarty_tpl->tpl_vars['data']->value['STATUS_OP']=='Belum'){?> 
                    <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/rencana_op/edit/').($_smarty_tpl->tpl_vars['data']->value['id']));?>
" class="button-edit">Edit</a>
                     
                    <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url((($tmp = @((('nurse/rencana_op/entry/').($_smarty_tpl->tpl_vars['data']->value['No_Reg'])).('/')).($_smarty_tpl->tpl_vars['data']->value['id']))===null||$tmp==='' ? '' : $tmp));?>
