<?php /* Smarty version Smarty-3.0.7, created on 2021-09-21 00:44:21
         compiled from "application/views\inap/rm10/list.html" */ ?>
<?php /*%%SmartyHeaderCode:31718606e6d37569e34-31405148%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7fe8ef48bb84d06d937b9b2f27cf57affb469fff' => 
    array (
      0 => 'application/views\\inap/rm10/list.html',
      1 => 1616214946,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '31718606e6d37569e34-31405148',
  'function' => 
  array (
  ),
...
<div class="head-content">
    <div class="head-content-nav">
        <!--<ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/rm10');?>
" class="active">Cari Data</a></li>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/rm10/cari2');?>
">Cari History</a></li>
        </ul>-->
        <div class="clear"></div>
    </div>
...
<div class="content-entry">
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/rm10/cari_process');?>
" method="post">
        <!--<input name="masuk_id" type="hidden" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['masuk_id'])===null||$tmp==='' ? '' : $tmp);?>
" />-->
        <table class="table-input" width="100%">
            <tr class="headrow">
                <th colspan="4">RM 10 Catatan Edukasi</th>
            </tr>
            <tr>
                <td>NO MR</td>
                <td colspan="3">
