...
//        print_r($result);exit();
            ...
            if (!empty($result)) {
                ...
                // set session
                $this->tsession->set_userdata('session_admin_emr', $result['user_id']);
                // insert login time
    ...
    public function logout_process() {
        // user id
        $user_id = $this->tsession->userdata('session_admin_emr');
        // insert logout time
        $this->m_account->update_user_logout($user_id);
        // unset session
        $this->tsession->unset_userdata('session_admin_emr');
        // output
        redirect('login/adminlogin');
    }
