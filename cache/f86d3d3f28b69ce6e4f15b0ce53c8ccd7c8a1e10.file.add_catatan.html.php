<?php /* Smarty version Smarty-3.0.7, created on 2021-09-20 16:13:13
         compiled from "application/views\inap/rm10/add_catatan.html" */ ?>
<?php /*%%SmartyHeaderCode:4467606e6d7f7fb400-77946276%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4467606e6d7f7fb400-77946276',
  'function' => 
  array (
  ),
...
<div class="head-content">
    <div class="head-content-nav">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('inap/rm10/edit/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
" >Data Umum</a></li>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('inap/rm10/add_catatan/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
...
" class="btn-red" title="Hapus Catatan"  onclick="return confirm('Apakah Anda Yakin Akan Menghapus?');">Hapus</a>
    ...
    <tr class="submit-box">
        <td colspan="6">
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('inap/rm10/edit/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
" class="btn-red" style="float:left;"/>Kembali</a>
            <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('inap/rm10/selesai/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
" class="btn-green" onclick="return confirm('Apakah Anda Yakin Akan Melanjutkan?');" style="float:right;"/>View</a>
        </td>
    </tr>
</table>
</form>
