...
<table class="content">
        ...
        <tbody>
<tr>
 <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;text-align: center;">
...
<td style="border-bottom:solid 1px #000000;text-align: center;">
    <?php if($ases2['FS_VERIF_PPJA']== '1'){?>
        <b>Verifikasi PPJA</b> <br><br>
        Tanggal <?= date('d-m-Y', strtotime($ases2['mdd_date_ppja']));?> Jam <?= $ases2['mdd_time_ppja'];?>
        <br><br>
        <qrcode value="<?= $ases2['FS_NM_PEG']; ?> pada <?= $vs['mdd_date_ppja']; ?> <?= $ases2['mdd_time_ppja']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>

        <br><br>
        <?= $ases2['FS_NM_PEG']; ?>
    <?php }else{ ?>
        <b>Verifikasi PPJA</b> <br><br>
        Tanggal 12-11-2020 Jam 09:08:15
        <br><br>
        <qrcode value="<?= $ases2['FS_NM_PEG']; ?> pada <?= $vs['mdd_date_ppja']; ?> <?= $ases2['mdd_time_ppja']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
        <br><br>
        Rubiyanto,S.Kep.Ns
...
<td style="border-right:solid 1px #000000;border-bottom:solid 1px #000000;text-align: center;">
    <?php if($ases2['FS_VERIF_PPJA']== '1'){?>
        ...
        <?= $ases2['FS_NM_PEG']; ?>
    <?php }else{ ?>
        <b>Verifikasi DPJP</b> <br><br>
        Tanggal 12-11-2020 Jam 14:16:28
        <br><br>
        <qrcode value="<?= $ases2['FS_NM_PEG']; ?> pada <?= $vs['mdd_date_ppja']; ?> <?= $ases2['mdd_time_ppja']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
        <br><br>
        WIBOWO M, H. DR., SP.PD.
