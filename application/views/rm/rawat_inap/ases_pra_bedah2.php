    ...
    <table class="content" style="font-size:11px; padding-top:0px;width:700px" >
        ...
        <tbody>
            ...
            <td style="border-left:solid 1px ;border-right:solid 1 px #000000;  border-top:solid 1px #000000; border-bottom:solid 1px #000000;">
                Data Subjektif : <br>
                   <?= strip_tags($rs_pra['DATA_S']); ?>
                   <BR>
                   <BR>
                   <BR>
                Data Objektif : <br>
                <?= strip_tags($rs_pra['DATA_O']); ?>
                   <BR>
                   <BR>
                   <BR>
                   Diagnosa Pra Bedah : <br>
                   <?= strip_tags($rs_pra['DIAGNOSA_PRA']); ?>
                   <BR>
                </td>
             <td style="border-left:solid 1px ;border-right:solid 1 px #000000;  border-top:solid 1px #000000; border-bottom:solid 1px #000000;">Verifikasi Pra Bedah : 
                ...
                <br>
                    ...
                    <table>
                    <tr><td>Status Pasien</td><td>: <?= strip_tags($rs_pra['V_STATUS_PASIEN']); ?></td></tr>
                    <tr><td>Asesmen Pra Bedah </td><td>: <?= strip_tags($rs_pra['V_ASES_PRA_LOK']); ?></td></tr>
                    <tr><td>Informed Consent Bedah</td><td>: <?= strip_tags($rs_pra['V_INFORMED_BEDAH']); ?></td></tr>
                    <tr><td>Informed Consent Anestesi </td><td>: <?= strip_tags($rs_pra['V_INFORMED_ANESTESI']); ?></td></tr>
                    <tr><td>Asesmen Pra Anestesi </td><td>: <?= strip_tags($rs_pra['V_PRA_ANESTESI']); ?></td></tr>
                    <tr><td>Edukasi Anestesi </td><td>: <?= strip_tags($rs_pra['V_EDU_ANESTESI']); ?></td></tr>
                    </table> 
                    <br>
                     Hasil pemeriksaan penunjang : <br>
                     <table>
                    <tr><td>Hb</td><td>: <?= strip_tags($rs_pra['HB']); ?></td></tr>
                    <tr><td>Leukosit </td><td>: <?= strip_tags($rs_pra['LEUKOSIT']); ?></td></tr>
                    <tr><td>Trombosit</td><td>: <?= strip_tags($rs_pra['TROMBOSIT']); ?></td></tr>
                    <tr><td>     Hematokrit </td><td>: <?= strip_tags($rs_pra['HEMATOKRIT']); ?></td></tr>
                    <tr><td>BT </td><td>: <?= strip_tags($rs_pra['BT']); ?></td></tr>
                    <tr><td>CT</td><td>: <?= strip_tags($rs_pra['CT']); ?></td></tr>
                    </table> 
                <br>
                <br>
                Pemeriksaan Lainnya :  <?= strip_tags($rs_pra['LAINNYA']); ?>
                <br>
                <br>

                Darah/Alat khusus yang diperlukan :  <?= strip_tags($rs_pra['ALAT_LAIN']); ?><br><br>
                Obat yang dibawa pasien :  <?= strip_tags($rs_pra['OBAT_YG_DIBAWA']); ?><br><br>
                Estimasi Waktu :  <?= strip_tags($rs_pra['ESTIMASI_WAKTU']); ?><br><br>
                Rencana Tindakan Pembedahan :  <?= strip_tags($rs_pra['RENCANA_TINDAKAN']); ?><br><br>
                </td>
