...
<div class="box box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">Data Award</h3>
    </div>
    ...
    <div class="box-body">
        ...
        <table id="tableDataAward" width="100%"
            data-toolbar="#toolbarGrid"
            data-toggle="table"
            data-pagination="true"
            data-show-refresh="true"
            data-url="<?php echo site_url('media/admin/sertifikasi/load_data_award/'); ?>"
        >
            <thead>
                <tr>
                    <th data-field="awardImage" data-formatter="imageFormatter">Gambar</th>
                    <th data-field="awardTitle">Judul</th>
                    <th data-field="awardStatus" data-align="center" data-formatter="statusAward">Status</th>                 
                    <th data-field="awardId" data-align="center" data-formatter="actionAward">Aksi</th>
                </tr>
            </thead>
        </table>
    </div>
...
var $tableDataAward = $('#tableDataAward');
var baseUrl = '<?php echo base_url(); ?>';

var actionAward = function(value,row,index){
    var htmlAksi = '';
   htmlAksi += '<a href="<?php echo site_url('media/admin/sertifikasi/form/'); ?>'+value+'" class="btn btn-xs btn-info btn-flat">EDIT</a> ';
    htmlAksi += '<a href="javascript:void(0)" onclick="doDeleteAward('+value+')" class="btn btn-xs btn-danger btn-flat">DELETE</a>';
    htmlAksi += '';
    return htmlAksi;
}


var statusAward = function(value,row,index){
    if(value == 'publish'){
    ...
    function(){
        $.post("<?php echo site_url('media/admin/sertifikasi/delete');?>",{id:id},function(response){
            if(response.status == 1){
                $tableDataAward.bootstrapTable("refresh");
            }
