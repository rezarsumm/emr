...
// load model
        ...
        $this->smarty->assign('m_farmasi', $this->m_farmasi);
    ...
    public function index() {
        ...
        $this->smarty->assign("data", $this->m_farmasi->get_warning_px($FS_KD_REG));
        $this->smarty->assign("rs_pasien2", $this->m_rawat_jalan->get_px_rj());
...
// get search parameter
        $this->smarty->assign("rs_pasien", $this->m_rawat_jalan->get_px_by_farmasi(array($FS_KD_REG)));
        $this->smarty->assign("result", $this->m_farmasi->get_warning_px($FS_KD_REG));
