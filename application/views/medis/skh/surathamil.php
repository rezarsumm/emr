...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        <tbody>
            ...
            <tr>
                <td align="center">
                <u> SURAT KETERANGAN KEHAMILAN </u>
...
<br>
    ...
    <br><br>
    Dengan kehamilan ke <?php echo $ket_sakit['Anakke'];?>, 
    usia kehamilan <?= $ket_sakit['Usia_hamil'];?> Minggu, dengan perkiraan persalinan 
    tanggal <?php echo date('d F Y', strtotime($ket_sakit['hpl']));?>   
    <br><br>
    Demikin surat keterangan ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.
    <br>
    <br>
    <br>
    <br>
