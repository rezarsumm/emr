                ...
                <td style="text-align: center; width: 65%">
                    <table class="content">
                        ...
                        <tbody>
                            ...
                            <?php 
                            if ($rs_resume['FS_VERIF_DOKTER'] == '0') { ?>
                                <tr>
                                    <td></td>
                                    <td></td>
                                </tr>
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    ...
                    if (empty($rs_resume['FD_TGL_KONTROL'])) {
                        ...
                        ?> 
                         <?= $rs_resume['KET_MASUK']; ?>  <?= $rs_resume['FS_KET_KONTROL']; ?>, Tanggal Kontrol :  <?= date('d-M-Y', strtotime($rs_resume['FD_TGL_KONTROL'])); ?> , Jam : <?= $rs_resume['FS_JAM_KONTROL']; ?>
                        <br>
                        <?php
...
<?php if ($rs_tind==null){
    ...
    <table class="content">
        <col style="width: 5%;font-size: 12px;">
...
?>
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:11pt">
    <page_header>
     <table class="page_header">
        <tr>
    ...
    <table class="content">
        <tbody>
            <col style="width: 100%;padding-top: 0px;font-size: 14px;">
            <tr>
                <td align="center">
                <?php 
                    $kers=new DateTime($rs_resume['FD_TGL_KONTROL']);
                    $rujukannya=new DateTime($rs_resume['TGL_EXPIRED_RUJUKAN']);
                  if($rs_resume['TGL_EXPIRED_RUJUKAN']==''){
        ...
        <tbody>
                     ...
                     <table class="content">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;text-align:center;border-right:solid 1px #000000; border-top:solid 1px #000000;"><b>Dosis</b></td>
                             </tr>
                            <?php
                            $no=1;
                            if ($rs_resume['FS_CARA_PULANG'] == '4') {
            ...
            <?php 
                  ...
                  if($rs_resume['TGL_EXPIRED_RUJUKAN']==''){?>
                            ...
                            <tr>
                            <td colspan="2"><br> 
                            <?php if($rs_resume['FD_TGL_KONTROL']==''){ ?>
                                Pasien dapat kontrol ke Rumah Sakit dengan catatan : <b>
                                <?php  echo $rs_resume['FS_KET_KONTROL']."</b>";

                            }
                            else{ ?>
                                Pasien dapat kontrol kembali ke Rumah Sakit  pada hari  <b>    <?= $dayList[date('D', strtotime($rs_resume['FD_TGL_KONTROL']))] . ',' . date('d M Y', strtotime($rs_resume['FD_TGL_KONTROL'])); ?> </b>,  di <b><?= $rs_resume['KET_MASUK']; ?></b>
                            
                                <br>
                                <?php
                            
                                if($rs_resume['FS_KET_KONTROL']!=null|| $rs_resume['FS_KET_KONTROL']!=''){ echo "Catatan : ".$rs_resume['FS_KET_KONTROL'];}?>
                ...
                <?php }
                    ...
                    <tr>
                        <td colspan="2"><br>Pasien dapat kontrol kembali pada <b> hari <?= $dayList[date('D', strtotime($rs_resume['FD_TGL_KONTROL']))] . ', tanggal ' . date('d M Y', strtotime($rs_resume['FD_TGL_KONTROL'])); ?></b> di <b><?= $rs_resume['KET_MASUK']; ?></b>
                          <?php
                   
                         if($rs_resume['FS_KET_KONTROL']!=null|| $rs_resume['FS_KET_KONTROL']!=''){ echo "<br> dengan <b>catatan : ".$rs_resume['FS_KET_KONTROL']."</b>";}?>
                        </td>

                    </tr>
                       <?php  if($rs_resume['TGL_EXPIRED_RUJUKAN']!=''){?>

                     <tr>
                        <td colspan="2"><br>Adapun tanggal expired/batas masa surat rujuk faskes sampai  <b> hari <?= $dayList[date('D', strtotime($rs_resume['TGL_EXPIRED_RUJUKAN']))] . ', tanggal ' . date('d M Y', strtotime($rs_resume['TGL_EXPIRED_RUJUKAN'])); ?></b>.
                       ...
                       <tr>
                <td colspan="2"><br><br>
                    Pasien dapat kontrol kembali ke Rumah Sakit setelah dari Faskes Primer pada hari  <b>    <?= $dayList[date('D', strtotime($rs_resume['FD_TGL_KONTROL']))] . ',' . date('d M Y', strtotime($rs_resume['FD_TGL_KONTROL'])); ?>. </b> di <b><?= $rs_resume['KET_MASUK']; ?></b> 
                    <br>
                    adapun tanggal expired rujukan adalah : <?= date('d M Y', strtotime($rs_resume['TGL_EXPIRED_RUJUKAN']));?>
                    <br>

                     <?php
                   
                     if($rs_resume['FS_KET_KONTROL']!=null|| $rs_resume['FS_KET_KONTROL']!=''){ echo "Catatan : <b>".$rs_resume['FS_KET_KONTROL']."</b><br><br>";}?>
    ...
    <table style="width: 100%; padding-left:250px">
            <tr>
                <td style="text-align: left; width: 35%">&nbsp;</td>
                <td style="text-align: center; width: 65%">
                    <table class="content">
