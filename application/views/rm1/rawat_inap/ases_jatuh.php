        ...
        <tbody>
            <tr>
                <td align="center" colspan="4" style="border-bottom:solid 1px #000000;border-left:solid 1px #000000;font-size: 12px;border-right:solid 1px #000000;">
                    <?php
                    if ($rs_pasien['fn_umur'] <= '18') {
                        echo "<b>Anak (1-18 tahun)</b>";
                    } elseif ($rs_pasien['fn_umur'] > '18' AND $rs_pasien['fn_umur'] <= '65') {
                        echo "<b>Dewasa Morse Fall Scale (>18-65 tahun)</b>";
                    } elseif ($rs_pasien['fn_umur'] > '65') {
                        echo "<b>Lanjut Usia (Ann Henrich >65 tahun)</b>";
                    }
                    ?>
                </td>
            </tr>
                ...
                foreach ($rs_result_anak as $data) {
                    ...
                    <tr>
                        ...
                        <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" >
                           ...
                           else if ($jatuh_anak >= '7' && $jatuh_anak <= '11'){
            ...
            <?php } ?>
            <?php } elseif ($rs_pasien['fn_umur'] > '18' AND $rs_pasien['fn_umur'] <= '65') { ?>
                <?php
            ...
            <?php } ?>
        <?php } elseif ($rs_pasien['fn_umur'] > '65') { ?>
            <?php
            foreach ($rs_result_dewasa2 as $data) {
                $rs_pencegahan = $this->m_ass_jatuh->get_pencegahan_jatuh_by_id(array($data['FS_KD_TRS2']));

                if($data['FS_PARAM_12']>0 && $data['FS_PARAM_13']>0 && $data['FS_PARAM_14']>0 && $data['FS_PARAM_15']>0 && $data['FS_PARAM_16']>0  && $data['FS_PARAM_17']>0){
                    $jt = $data['FS_PARAM_12'] + $data['FS_PARAM_13'] + $data['FS_PARAM_14'] + $data['FS_PARAM_15'] + $data['FS_PARAM_16'] + $data['FS_PARAM_17'];
                    ...
                    <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" >
                        Disorientasi : <?= $data['FS_PARAM_12'] ;?> <br>
                        Gangguan Gaya berjalan : <?= $data['FS_PARAM_13'];?> <br>
                        Riwayat Jatuh dalam 12 bulan : <?=$data['FS_PARAM_14'];?> <br>
                        Obat Berisiko tinggi : <?=$data['FS_PARAM_15'];?> <br>
                        Gangguan Pendengaran, Pengelihatan : <?= $data['FS_PARAM_16'];?> <hr>
                       Pusing/Vertigo : <?= $data['FS_PARAM_17'];?> <hr>
                        Skor : <?= $jt; ?> <br>
                        Kesimpulan : 
                        <?php
                        if ($jt >= '0' && $jt <= '4') {
