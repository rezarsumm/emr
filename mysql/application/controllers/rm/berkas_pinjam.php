...
class berkas_pinjam extends ApplicationBase {
...
// set template content
        $this->smarty->assign("template_content", "rm/berkas_pinjam/index.html");
...
// get search parameter
        $this->smarty->assign("rs_pasien", $this->m_rm->get_px_history2_pinjam(array($this->com_user['user_name'],date('Y-m-d'))));
...
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "rm/berkas_pinjam/detail.html");
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
        // load style
...
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "rm/berkas_pinjam/pinjam.html");
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
        // load style
