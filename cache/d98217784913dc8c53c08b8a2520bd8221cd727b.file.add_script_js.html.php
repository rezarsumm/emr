<?php /* Smarty version Smarty-3.0.7, created on 2021-09-20 15:44:52
         compiled from "application/views\inap/rm17/add_script_js.html" */ ?>
<?php /*%%SmartyHeaderCode:16203606e6c06876b35-64866588%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd98217784913dc8c53c08b8a2520bd8221cd727b' => 
    array (
      0 => 'application/views\\inap/rm17/add_script_js.html',
      1 => 1616214946,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16203606e6c06876b35-64866588',
  'function' => 
  array (
  ),
...
//            $('#tujuan').select2('data', null);
        if (user == '') {
            $("#tujuan").attr("disabled", "disabled");
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $_smarty_tpl->getVariable('config')->value->site_url('surat/resume/list_diet/');?>
",
                    data: "user=" + user,
                    dataType: 'json',
