        ...
        <?php } ?>
         ...
         <tr> 
           ...
           <!--  <tr>
            ...
            <?php if($h['DPJP_UTAMA']!=''){?>  
             <tr>
                <td style="border-left:solid 1px #000000;">Konsul</td>
                <td style="border-right:solid 1px #000000; font-size: 8px;">
                 DPJP Utama :  <?php echo $h['DPJP_UTAMA']; ?> , <?php echo $h['KONSUL_DPJP_UTAMA']; ?> <br>
                </td>
            </tr>
            <?PHP } ?>
