<?php /* Smarty version Smarty-3.0.7, created on 2021-03-15 15:23:56
         compiled from "application/views\nurse/antenatal/index.html" */ ?>
<?php /*%%SmartyHeaderCode:11484604f199cdd15d1-97027188%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c35898cc4ff384335802acc97398e5d54296f47c' => 
    array (
      0 => 'application/views\\nurse/antenatal/index.html',
      1 => 1608812814,
      2 => 'file',
  ...
  'nocache_hash' => '11484604f199cdd15d1-97027188',
  'function' => 
  array (
  ),
...
<div class="search-box">
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('nurse/antenatal/proses_cari');?>
" method="post">
...
<!--<div class="navigation">
    ...
    <div class="navigation-button">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/rawat_jalan/rekap_excel/').(''));?>
...
resource/doc/images/icon/icon.waiting.farmasi.png" alt="" />
                ...
                <td>
                    ...
                    <a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('nurse/antenatal/history/').($_smarty_tpl->tpl_vars['data']->value['FS_MR'])).('/')).($_smarty_tpl->getVariable('search')->value['FS_KD_PEG']));?>
...
', 'nama_window_pop_up', 'scrollbars=yes,resizeable=no')" class="button-edit">Kendali</a>
                    ...
                    <a  href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('medis/rawat_jalan/cetak_skdp/').($_smarty_tpl->tpl_vars['data']->value['FS_KD_REG'])).('/')).($_smarty_tpl->tpl_vars['data']->value['FS_KD_TRS']));?>
...
', 'nama_window_pop_up', 'scrollbars=yes,resizeable=no')" class="button-edit">Rujukan Internal</a>
                    <?php }else{ ?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['data']->value['REG_LAB']!=''){?>
                    <a  href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('rm/rawat_jalan/cetak_rujukan_lab/').($_smarty_tpl->tpl_vars['data']->value['FS_KD_REG']));?>
', 'nama_window_pop_up', 'scrollbars=yes,resizeable=no')" class="button-edit">Lab</a>
                    <?php }else{ ?>
                    <?php }?>
                    <?php if ($_smarty_tpl->tpl_vars['data']->value['REG_RAD']!=''){?>
                    <a  href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('rm/rawat_jalan/cetak_rujukan_rad/').($_smarty_tpl->tpl_vars['data']->value['FS_KD_REG']));?>
