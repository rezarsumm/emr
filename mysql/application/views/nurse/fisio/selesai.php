...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        ...
        NO <?= $rs_pasien['FS_KD_TRS']; ?>/<?= $rs_pasien['FS_KD_LAYANAN_BPJS'] ?>/<?= date('m'); ?>/<?= date('Y'); ?>
        </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2"> <br><br>Sudah dilakukan tindakan Fisioterapi dan dinyatakan telah <b>SELESAI</b></td>
