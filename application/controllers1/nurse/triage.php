...
class triage extends ApplicationBase {
...
// set template content
        $this->smarty->assign("template_content", "nurse/triage/index.html");
...
// get search parameter
        $this->smarty->assign("rs_dokter", $this->m_igd->get_dokter());
        $this->smarty->assign("rs_pasien", $this->m_igd->get_px_by_dokter_wait_igd(array($FD_TGL_MASUK, $FS_KD_PEG, $FS_KD_PEG, $FS_KD_PEG)));
        //$this->smarty->assign("rs_pasien2", $this->m_igd->get_px_by_dokter_finish_perawat(array($now, $FS_KD_PEG)));
// notification
...
// output
    ...
    public function proses_cari() {
        ...
        if ($this->input->post('save') == "Reset") {
            $this->tsession->unset_userdata("nurse_igd");
        } else {
            $params = array(
                "FD_TGL_MASUK" => $this->input->post("FD_TGL_MASUK"),
                "FS_KD_PEG" => $this->input->post("FS_KD_PEG")
            );
            $this->tsession->set_userdata("nurse_igd", $params);
        }
        // redirect
        redirect("nurse/igd");
    }
    ...
    public function add_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_igd->insert($params)) {
                ...
                $this->m_igd->insert_nyeri($params2);
                $params3 = array(
                    $this->input->post('FS_KD_REG'),
                ...
                $this->m_igd->insert_jatuh($params3);
                $params4 = array(
                    $this->input->post('FS_KD_REG'),
                ...
                $this->m_igd->insert_ases($params4);
                $params5 = array(
                    $this->input->post('FS_KD_REG'),
                ...
                $this->m_igd->insert_alergi($params5);
                $params6 = array(
                    $this->input->post('FS_KD_REG'),
                ...
                $this->m_igd->insert_nutrisi($params6);

// insert tujuan
                $masalah_kep = $this->input->post('tujuan');
                if (!empty($masalah_kep)) {
                    foreach ($masalah_kep as $value) {
                        $this->m_igd->insert_masalah_kep(array($this->input->post('FS_KD_REG'), $value));
                    }
                }
                $rencana_kep = $this->input->post('tembusan');
                if (!empty($rencana_kep)) {
                    foreach ($rencana_kep as $value) {
                        $this->m_igd->insert_rencana_kep(array($this->input->post('FS_KD_REG'), $value));
                    }
                }
...
// set template content
        ...
        $this->smarty->assign("vs", $this->m_igd->get_data_vs_by_rg(array($FS_KD_REG)));
        $this->smarty->assign("nyeri", $this->m_igd->get_data_nyeri_by_rg(array($FS_KD_REG)));
        $this->smarty->assign("jatuh", $this->m_igd->get_data_jatuh_by_rg(array($FS_KD_REG)));
        ...
        // get instansi tujuan
        $tujuan = $this->m_igd->list_masalah_kep_by_rg($FS_KD_REG);
        $tujuan_str = "";
        ...
        $tembusan = $this->m_igd->list_rencana_kep_by_rg($FS_KD_REG);
        $tembusan_str = "";
    ...
    public function edit_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_igd->update($params)) {
                ...
                $this->m_igd->update_nyeri($params2);
                $params3 = array(
                    $this->input->post('FS_CARA_BERJALAN1'),
                    $this->input->post('FS_CARA_BERJALAN2'),
                    $this->input->post('FS_CARA_DUDUK'),
                ...
                $this->m_igd->update_jatuh($params3);
                ...
                $this->m_igd->update_ases($params4);
                ...
                $this->m_igd->update_alergi($params5);
                $params6 = array(
                    $this->input->post('FS_NUTRISI1'),
                    $this->input->post('FS_NUTRISI2'),
                    $this->input->post('FS_NUTRISI_ANAK1'),
                ...
                $this->m_igd->update_nutrisi($params6);
                $masalah_kep = $this->input->post('tujuan');
                $this->m_igd->delete_masalah_kep($this->input->post('FS_KD_REG'));
                if (!empty($masalah_kep)) {
                    foreach ($masalah_kep as $value) {
                        $this->m_igd->insert_masalah_kep(array($this->input->post('FS_KD_REG'), $value));
                    }
                ...
                $rencana_kep = $this->input->post('tembusan');
                $this->m_igd->delete_rencana_kep($this->input->post('FS_KD_REG'));
                if (!empty($rencana_kep)) {
                    foreach ($rencana_kep as $value) {
                        $this->m_igd->insert_rencana_kep(array($this->input->post('FS_KD_REG'), $value));
                    }
