...
class rad_inap extends ApplicationBase {
...
// set template content
        $this->smarty->assign("template_content", "rad/rawat_inap/index.html");
 ...
 // get search parameter
        ...
        $this->smarty->assign("rs_pasien", $this->m_farmasi_inap->get_px_by_radio(array($FD_TGL_TRS)));
 // notification
 ...
 // output
  ...
  $data["alamat"] = $this->m_rawat_jalan->get_alamat();
        ...
        $this->load->view('rad/rawat_inap/print_igd', $data);
       ...
       public function cetak_prad($FS_KD_TRS = "") {
        $this->_set_page_rule("R");
        $this->load->library('html2pdf');
        $now = date('Y-m-d');
  ...
  $data["alamat"] = $this->m_rawat_jalan->get_alamat();
        ...
        $this->load->view('rad/rawat_inap/print', $data);
         $content = ob_get_contents();
        ob_end_clean();
