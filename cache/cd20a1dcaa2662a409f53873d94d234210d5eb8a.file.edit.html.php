<?php /* Smarty version Smarty-3.0.7, created on 2022-07-14 09:04:14
         compiled from "application/views\op/laporan/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:2284962cf799edfe935-61802031%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd20a1dcaa2662a409f53873d94d234210d5eb8a' => 
    array (
      0 => 'application/views\\op/laporan/edit.html',
      1 => 1653985247,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2284962cf799edfe935-61802031',
  'function' => 
  array (
  ),
...
<div class="content-entry">
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('op/laporan/edit_process');?>
...
?>
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['NAMALENGKAP']==$_smarty_tpl->getVariable('rs_lap_op3')->value['KD_ASISTEN']){?>
...
"><?php echo $_smarty_tpl->tpl_vars['data']->value['NAMALENGKAP'];?>
            ...
            <tr>
                ...
                <td width="20%">
                    <input type="text" name="DIAGNOSA_PRA" value="<?php echo $_smarty_tpl->getVariable('rs_lap_op3')->value['DIAGNOSA_PRA'];?>
" class="form-control">
                </td>

                <td width="20%">Diagnosa Post-operatif</td>
                <td width="20%">
                    <input type="text" name="DIAGNOSA_POST" value="<?php echo $_smarty_tpl->getVariable('rs_lap_op3')->value['DIAGNOSA_POST'];?>
" value="" class="form-control">
           ...
           <tr>
            ...
            <td >
                <textarea name="BAGIAN_EKSISI" rows="2" style="width: 350px;" ><?php echo $_smarty_tpl->getVariable('rs_lap_op3')->value['BAGIAN_EKSISI'];?>
 </textarea>
                </td>
           ...
           <tr>
            <td>Nama Operasi</td>
            <td >
                <textarea name="NAMA_OPERASI" rows="2" style="width: 350px;" ><?php echo $_smarty_tpl->getVariable('rs_lap_op3')->value['NAMA_OPERASI'];?>
  </textarea>
                </td>
...
" style="width: 150px;" > </input>
                     ...
                     <td>Jam Operasi 
                        ...
                        <td >
                            <input type="time" name="JAM_MULAI" rows="1" value="<?php echo date('H:i',strtotime($_smarty_tpl->getVariable('rs_lap_op3')->value['JAM_MULAI']));?>
"  style="width: 80px;" > </input>  - 
                            <input type="time" name="JAM_SELESAI" rows="1"  value="<?php echo date('H:i',strtotime($_smarty_tpl->getVariable('rs_lap_op3')->value['JAM_SELESAI']));?>
"  style="width: 80px;" > </input>
                            </td>
            ...
            <tr>
                        ...
                        <td >
                            <textarea name="URAIAN_LAPORAN" rows="6" style="width: 350px;" > <?php echo $_smarty_tpl->getVariable('rs_lap_op3')->value['URAIAN_LAPORAN'];?>
 </textarea>
                            </td>
