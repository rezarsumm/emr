...
class m_operator extends CI_Model {
    ...
    function get_all_users() {
        $sql = "SELECT a.*, b.*, d.*, e.role_nm
                ...
                JOIN DB_RSMM.dbo.TUSER b ON a.user_name = b.NamaUser
    ...
    function get_all_users_limit($params) {
        $sql = "SELECT a.user_id, a.user_mail, b.*, e.role_nm,Nama_Bangsal
                FROM PKU.dbo.tac_com_user a
                LEFT JOIN DB_RSMM.dbo.TUSER b ON a.user_name = b.NamaUser
                INNER JOIN PKU.dbo.tac_com_role_user d ON a.user_id = d.user_id
                INNER JOIN PKU.dbo.tac_com_role e ON d.role_id = e.role_id
                LEFT JOIN DB_RSMM.dbo.M_BANGSAL f ON a.fs_kd_layanan = f.Kode_Bangsal
                WHERE a.user_id <> 1 AND e.portal_id = 2
    ...
    function get_users_by_id($id) {
        $sql = "SELECT a.*, b.*, a.user_id, c.role_id, d.role_nm 
                ...
                LEFT JOIN DB_RSMM.dbo.TUSER b ON a.user_name = b.NamaUser WHERE a.user_id = ?";
    ...
    function get_list_unit() {
        $sql = "SELECT * FROM M_BANGSAL ORDER BY Nama_Bangsal ASC";
        $query = $this->db->query($sql);
    ...
    function insert($params) {
        ...
        $sql = "INSERT INTO PKU.dbo.tac_com_user (user_name, user_pass, user_key, user_mail, lock_st, mdb, mdd,fs_kd_layanan)
                VALUES (?, ?, ?, ?, ?, ?, GETDATE(),?)";
        return $this->db->query($sql, $params);
    }
