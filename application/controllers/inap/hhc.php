...
class hhc extends ApplicationBase {
    ...
    public function index() {
        ...
        if ($role == '6' || $role == '11' || $role == '5' || $role == '23' || $role == '9' || $role == '8' || $role == '17'|| $role == '19') {
            $this->smarty->assign("rs_pasien", $this->m_hhc->get_pasien_bangsal(array($date, $date2, $date, $date, $date, $date, $date, $date, $date, $date, $date)));
        } else {
            $this->smarty->assign("rs_pasien", $this->m_hhc->get_pasien_bangsal_by_bangsal(array($date, $date2, $this->com_user['fs_kd_layanan'])));
        }
        // notification
