<?php /* Smarty version Smarty-3.0.7, created on 2022-03-07 13:26:30
         compiled from "application/views\medis/skh/edit_suratsakit.html" */ ?>
<?php /*%%SmartyHeaderCode:118556225a596ef2870-26604133%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acc35ccaba3e57bda330179b46fbdf1f622bc7f4' => 
    array (
      0 => 'application/views\\medis/skh/edit_suratsakit.html',
      1 => 1646634380,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118556225a596ef2870-26604133',
  'function' => 
  array (
  ),
...
">Rawat Jalan</a><span></span>
        <small>Edit Surat Keterangan Kehamilan</small>
    </p>
    <div class="clear"></div>
</div>
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/skh/update_suratsakit');?>
" method="post">
    ...
    <table class="table-input" width="80%">
        ...
        <tr><td> </td></tr>
         <tr>
            ...
            <td > <input type="text" value="<?php echo $_smarty_tpl->getVariable('ket_sakit')->value['Pekerjaan'];?>
" name="pekerjaan" style="width: 400px;">
            </td>
        </tr>
          <tr>
            <td>
            ...
            <td > <input type="text" value="<?php echo $_smarty_tpl->getVariable('ket_sakit')->value['Anakke'];?>
" name="Anakke" style="width: 400px;">
            </td>
        </tr>
          <tr>
            <td>
            ...
            <td > <input type="text" value="<?php echo $_smarty_tpl->getVariable('ket_sakit')->value['Usia_hamil'];?>
"  name="Usia_hamil" style="width: 400px;" onkeypress="return angka(event);"> minggu
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td > <input type="date" value="<?php echo $_smarty_tpl->getVariable('ket_sakit')->value['HPL'];?>
"  name="hpl"   style="width: 400px;">
            </td>
        </tr>
