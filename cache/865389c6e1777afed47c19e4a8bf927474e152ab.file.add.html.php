<?php /* Smarty version Smarty-3.0.7, created on 2023-04-14 08:22:44
         compiled from "application/views\igd/bidan/add.html" */ ?>
<?php /*%%SmartyHeaderCode:230826438aae404ee42-28712836%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '230826438aae404ee42-28712836',
  'function' => 
  array (
  ),
            ...
            <tr>
                ...
                <td>  
                  ...
                  Bila iya,  Diberikan ke petugas 
                    <input type="radio" name="BERI" value="Ya">Ya    
                    <input type="radio" name="BERI" checked value="Tidak">Tidak    
                </td>
             </tr>  
       ...
       <table class="table-input" width="100%">
        ...
        <tr>
            ...
            <td> <input type="text" name="JAM_TERAKHIR_BAK">  
                Warna BAK  <input type="text" name="KARAKTER_BAK"> </td>
        </tr>
        <tr>
            <td> Pola BAB</td>
...
"/> Kg</td>
        ...
        <table class="table-input" width="100%">
            ...
            <tr> 
                ...
                <td> 
                    <input type="radio" name="CEK_DADA" value="Kolostrum">  
                    <input type="hidden" name="CEK_DADA" value=""> Kolostrum </td>
                </tr>
              <tr>
                    <td > </td>
               <tr> 
                   ...
                   <td>Inspeksi Abdomen</td>
                    <td colspan="3"> <input type="radio" name="INSPEKSI_ABDOMEN" value="Luka Bekas OP" >  Luka Bekas OP  
                        ...
                        <input type="radio" name="INSPEKSI_ABDOMEN" value="Linea Nigra">   Linea Nigra  
                          ...
                          <input type="radio" name="INSPEKSI_ABDOMEN" value="Striae Albican">  
                          <input type="hidden" name="INSPEKSI_ABDOMEN" value="">   Striae Albican </td>
        ...
        <tr>
            ...
            <td>Radiologi</td>
            <td>   <select name="tembusan[]" multiple id="tembusan" style="width:200px">
                <option></option>
            </select></td>
        </tr>
...
<table class="table-input" width="100%">
    ...
    <tr>
        ...
        <td width='30%' colspan="3">
           <input type="text" name="RENCANA_TIN"  style="width: 600px;">
        </td> 
    </tr>
    ...
    <table class="table-input" width="100%">
        ...
        <tr>
            ...
            <td width='30%'> 
                <input type="radio" name="KRITERIA_DISCHARGE[]" value="Umur>65">Umur>65<br>
                <input type="radio" name="KRITERIA_DISCHARGE[]" value="Terbatas Mobilitas">Terbatas Mobilitas<br>
                <input type="radio" name="KRITERIA_DISCHARGE[]" value="Perawatan Lanjutan">Perawatan Lanjutan<br>
                <input type="radio" name="KRITERIA_DISCHARGE[]" value="Bantuan Aktifitas Sehari hari">Bantuan Aktifitas Sehari hari<br>
            </td>
