<?php /* Smarty version Smarty-3.0.7, created on 2022-02-02 12:58:56
         compiled from "application/views\medis/ket_rawat/edit_suratsakit.html" */ ?>
<?php /*%%SmartyHeaderCode:1986661fa1da0b49647-82767354%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9075ee3ae5238c562a26b41353635ec0e252708' => 
    array (
      0 => 'application/views\\medis/ket_rawat/edit_suratsakit.html',
      1 => 1643781534,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1986661fa1da0b49647-82767354',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/ket_rawat/update');?>
" method="post">
...
" />
    ...
    <table class="table-input" width="50%">
        ...
        <tr>
            ...
            <td > <input type="text" value="<?php echo $_smarty_tpl->getVariable('ket_sakit')->value['DIAGNOSA'];?>
" name="diagnosa" style="width: 400px;">
            </td>
        </tr>
