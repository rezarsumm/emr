...
class surat_sakit extends ApplicationBase {
...
// set template content
        $this->smarty->assign("template_content", "medis/surat_sakit/index.html");
...
// get search parameter
       ...
       if($x=='216'|| $x=='217' || $x=='211'  || $x=='215'|| $x=='213'|| $x=='202' || $x=='203' || $x=='206'  || $x=='211' || $x=='207' || $x=='209' || $x=='219'  || $x=='220' || $x=='221' || $x=='312' || $x=='222' || $x=='223'|| $x=='208' ||  $x=='224' ||  $x=='225' || $x=='226' || $x=='227' || $x=='229' || $x=='230' || $x=='231' || $x=='232' || $x=='233'){
...
// output
    ...
    public function create_suratsakit($FS_KD_REG = "") { 
        ...
        if ($ceksuratsakit >= '1') {
           ...
           $this->_set_page_rule("R");
           // set template content
                   $this->smarty->assign("template_content", "medis/surat_sakit/edit_suratsakit.html");
        ...
        // set page rules
                $this->_set_page_rule("R");
        // set template content
                $this->smarty->assign("template_content", "medis/surat_sakit/create_suratsakit.html");
                $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                $this->smarty->load_javascript('resource/js/jquery/select2.js');
                $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
     ...
     public function simpan_suratsakit() {
            ...
            public function cetak_suratsakit($FS_KD_REG = "") {
               $this->_set_page_rule("R");
                ...
                $data['ket_sakit']= $this->m_rawat_jalan->data_surat_sakit(array($FS_KD_REG));
                 ob_start();
                $this->load->view('medis/ket_sakit/suratsakit', $data);
            ...
            public function create_skd($FS_KD_REG = "") { 
                ...
                if ($cekskd >= '1') {
                   ...
                   $this->_set_page_rule("R");
                   // set template content
                           $this->smarty->assign("template_content", "medis/surat_sakit/edit_skd.html");
                           $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                           $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                           $this->smarty->load_javascript('resource/js/jquery/select2.js');
                           $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
                ...
                // set page rules
                        $this->_set_page_rule("R");
                // set template content
                        $this->smarty->assign("template_content", "medis/surat_sakit/create_skd.html");
                        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                        $this->smarty->load_javascript('resource/js/jquery/select2.js');
                        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
         ...
         public function update_skd() {
                    ...
                    public function cetak_skd($FS_KD_REG = "") {
                        ...
                        $data['ket_skd']= $this->m_rawat_jalan->data_skd(array($FS_KD_REG));
                         ob_start();
                        $this->load->view('medis/surat_sakit/skd', $data);
                        $content = ob_get_contents();
                        ob_end_clean();
