<?php /* Smarty version Smarty-3.0.7, created on 2022-01-13 10:04:29
         compiled from "application/views\medis/rawat_jalan/add_rujuk_internal.html" */ ?>
<?php /*%%SmartyHeaderCode:2081861df96bda34fc2-02876933%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '357b19aa0df2a3d9a2af1cc37ab23aeff44f0c96' => 
    array (
      0 => 'application/views\\medis/rawat_jalan/add_rujuk_internal.html',
      1 => 1642043014,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2081861df96bda34fc2-02876933',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/rawat_jalan/add_rujuk_process');?>
" method="post">
...
<br> 2. <?php echo $_smarty_tpl->getVariable('result')->value['DOK2'];?>
    ...
    <table class="table-input" width="100%">
        ...
        <tr>
            ...
            <td width='85%'>
                 <select name="FS_TUJUAN_RUJUKAN" multiple id="tujuankonsul" required="" style="width:250px">
                    <option></option>
                    </select>
