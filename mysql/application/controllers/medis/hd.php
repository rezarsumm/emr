...
// output
    ...
    public function history($FS_MR = "",$FS_KD_MEDIS="") {
// set page rules
        $this->_set_page_rule("R");
// set template content
...
// output
    ...
    public function add_process() {
        ...
        if ($this->input->post('FS_CARA_PULANG') == '2') {
            ...
            redirect("medis/hd/add_rujuk/" . $this->input->post('FS_KD_REG'));
        } else {
            redirect("medis/hd/cetak/" . $this->input->post('FS_KD_REG') . '/' . $FS_KD_TRS);
        }
    }
...
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "medis/hd/add_rujuk.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
