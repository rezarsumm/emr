        ...
        <tbody>
           ...
           foreach ($rs_kep as $data){
            ...
            <tr>
                ...
                <th style="border-bottom:solid 1px #000000;border-right:solid 1px #000000; padding:0px 2px" >
                    <?= $data['FS_NM_DIAGNOSA'];?>
                </th>
                <th style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;  padding:0px 2px" >
                    <?= $data['FS_NM_NOC'];?>
            ...
            echo "-".$data2['FS_NM_NIC2']."<br>";
                ...
                <th style="border-bottom:solid 1px #000000;border-right:solid 1px #000000; text-align: left;  padding:0px 4px">
