        ...
        class aplusan extends ApplicationBase {
            ...
            public function index() {
                ...
                // notification
                //$this->smarty->assign("rs_id", $this->m_aplusan->get_list_aplusan_lap(array($date, $date2, $layanan, $tanggal)));
            ...
            public function add($FS_KD_REG = "", $FS_KD_TRS = "") {
                ...
                $date = date('Y-m-d');
                $date2 = date('Y-m-dH:i:s');
                $this->smarty->assign("rs_pasien", $this->m_aplusan->get_pasien_by_rg(array($date, $date2, $FS_KD_REG)));
        ...
        // detail
                ...
                $date2 = date('Y-m-dH:i:s');
                $this->smarty->assign("rs_pasien", $this->m_aplusan->get_pasien_by_rg(array($date, $date2,$FS_KD_REG)));
                $this->smarty->assign("result", $this->m_aplusan->get_aplusan_by_id(array($date, $date2, $date, $date, $date, $date, $date, $date, $date, $date, $date, $FS_KD_APLUSAN)));
        // notification
                $this->tnotification->display_notification();
                $this->tnotification->display_last_field();
        // output
        ...
        // default redirect
            ...
            public function cetak() {
                ...
                $data['rs_result'] =$this->m_aplusan->get_list_aplusan_lap(array($date, $date2, $layanan, $tanggal));
                ob_start();
                $this->load->view('inap/aplusan/print', $data);
