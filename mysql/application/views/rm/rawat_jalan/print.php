        ...
        <table class="content">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="border-right:solid 1px #000000;"> :
                    <?php echo $ases2['FS_PEMERIKSAAN_FISIK']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;"><b>Edukasi</b></td>
                    <td style="border-right:solid 1px #000000;"> :
                <?php echo $ases2['FS_EDUKASI']; ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="border-left:solid 1px #000000;"><b>Asesmen Geriatri</b></td>
                    <td style="border-right:solid 1px #000000;"></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;">Pasien usia diatas 60 tahun dengan memiliki lebih dari 1 (satu) penyakit fisik dan/atau psikis</td>
                    <td style="border-right:solid 1px #000000;">
                        : <?php
                        if ($geriatri['FS_GERIATRI1'] == '1') {
                            echo "YA";
                        } elseif ($geriatri['FS_GERIATRI1'] == '0') {
                            echo "TIDAK";
                        } else {
                            echo "-";
                        }
                ...
                <tr>
                    <td style="border-left:solid 1px #000000;">Pasien usia diatas 60 tahun memiliki 1 (satu) penyakit dan mengalami gangguan akibat penurunan fungsi organ, psikologi, sosial, ekonomi dan lingkungan yang membutuhkan pelayanan kesehatan</td>
                    <td style="border-right:solid 1px #000000;">
                        : <?php
                        if ($geriatri['FS_GERIATRI2'] == '1') {
                            echo "YA";
                        } elseif ($geriatri['FS_GERIATRI2'] == '0') {
                            echo "TIDAK";
                        } else {
                            echo "-";
                        }
                ...
                <tr>
                    <td style="border-left:solid 1px #000000;">Pasien usia diatas 70 tahun yang memiliki 1 (satu) penyakit fisik dan/atau psikis</td>
                    <td style="border-right:solid 1px #000000;">
                        : <?php
                        if ($geriatri['FS_GERIATRI3'] == '1') {
                            echo "YA";
                        } elseif ($geriatri['FS_GERIATRI3'] == '0') {
                            echo "TIDAK";
                        } else {
                            echo "-";
                        }
                ...
                <tr>
                    ...
                    <td style="border-right:solid 1px #000000;"><strong>
                            : <?php
                            $kesimpulangr = $geriatri['FS_GERIATRI1'] + $geriatri['FS_GERIATRI2'] + $geriatri['FS_GERIATRI3'];
                            if ($kesimpulangr >= '1') {
                                echo "BERI PELAYANAN KHUSUS TANPA ANTRI";
                            } else{
                                echo "-";
                            }
                            ?>
    ...
    <page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
        ...
        <table class="content">
            ...
            <tbody>
                ...
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>Edukasi</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($result['FS_EDUKASI']); ?></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>Time Out</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($result['FS_TIME_OUT']); ?></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>Planning</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($result['FS_PLANNING']); ?></td>
                </tr>
                <tr>
