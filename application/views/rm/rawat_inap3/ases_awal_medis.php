...
<page_header>
 ...
 <br>
    <table class="content" style="padding-top: 30px">
        ...
        <tr>
            <td align="center">
             <?php if($h['KONJUNGTIVA']!=''){ echo 'ASESMEN AWAL MEDIS';} else{ echo 'FORM RENCANA RAWAT INAP';}?>
    ...
    <table class="content" style="font-size:11px; padding-top:0px" >
        <col style="width: 40%;font-size: 11px;">
        <col style="width: 60%;font-size: 11px;">
        <tbody>
  
            <tr>
                <td style="border-left:solid 1px ; border-top:solid 1px #000000;">Anamnesa</td>
             ...
             <tr>
                ...
                <td style="border-right:solid 1px ;border-top:solid 1px ;">
        ...
        <?php } ?>
          ...
          <?php if($h['EKS_ATAS']!='' || $h['EKS_BAWAH']!=''){?>
              ...
              <tr>
                ...
                <td style="border-right:solid 1px #000000;">  Atas : <?= $h['EKS_ATAS'];?><br>Bawah : <?= $h['EKS_BAWAH'];?>    
                </td>
            </tr>
        <?php } ?>
         ...
         <tr> 
           ...
           <!--  <tr>
            ...
            <tr>
                ...
                <td style="border-right:solid 1px #000000; font-size: 11px;">
    ...
    <br>
    <br>
   <div class="d" style=" font-size: 11px;"> Catatan untuk Pasien : <?=$h['FS_PESAN'];?></div>
</page> 
...
<?php } if ($cekrajal >= '1') { ?>
    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                <td style="font-size: 11px;border-bottom:solid 1px #000000;" colspan="2"><b>ASESMEN KEPERAWATAN</b></td>
            </tr>
            <tr>
