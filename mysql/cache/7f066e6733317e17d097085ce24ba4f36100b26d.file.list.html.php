<?php /* Smarty version Smarty-3.0.7, created on 2021-03-16 11:01:03
         compiled from "application/views\inap/resume/list.html" */ ?>
<?php /*%%SmartyHeaderCode:3235460502d7fc39a86-24112304%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7f066e6733317e17d097085ce24ba4f36100b26d' => 
    array (
      0 => 'application/views\\inap/resume/list.html',
      1 => 1609892769,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3235460502d7fc39a86-24112304',
  'function' => 
  array (
  ),
...
<!--<div class="head-content">
    <div class="head-content-nav">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/resume/');?>
" class="active">Cari Data</a></li>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/resume/cari2');?>
">Cari History</a></li>
        </ul>
        <div class="clear"></div>
    </div>
...
<div class="content-entry">
 ...
 echo $_template->getRenderedTemplate();?><?php unset($_template);?>
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/resume/cari_process');?>
" method="post">
        <!--<input name="masuk_id" type="hidden" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['masuk_id'])===null||$tmp==='' ? '' : $tmp);?>
" />-->
        <table class="table-input" width="100%">
            <tr class="headrow">
                <th colspan="4">Resume Pasien Pulang</th>
            </tr>
            <tr>
                <td>NO MR</td>
                <td colspan="3">
