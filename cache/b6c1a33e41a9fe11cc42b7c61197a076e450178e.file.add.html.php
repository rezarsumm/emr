<?php /* Smarty version Smarty-3.0.7, created on 2023-04-14 09:31:42
         compiled from "application/views\igd/cppt/add.html" */ ?>
<?php /*%%SmartyHeaderCode:114706438bb0ea7b431-84874911%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '114706438bb0ea7b431-84874911',
  'function' => 
  array (
  ),
        ...
        <table class="table-input" width="100%" style="text-align: justify;">
           <tr>
            ...
            <tr>
                <td>O / D</td>
                <td>
                    <textarea name="FS_CPPT_O" rows="3" cols="100%" onkeypress="handle6(event)" class="form-control objek"></textarea>
                </td>
            </tr>
            <tr>
                <td>A / I</td>
...
<br>
          ...
          <?php if ($_smarty_tpl->tpl_vars['cppt']->value['FS_LAB']!=''){?> 
               <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('lab/lab_igd/cetak_plab/').($_smarty_tpl->tpl_vars['cppt']->value['FS_KD_TRS']));?>
