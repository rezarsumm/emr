<?php /* Smarty version Smarty-3.0.7, created on 2022-10-14 10:23:51
         compiled from "application/views\inap/ews.html" */ ?>
<?php /*%%SmartyHeaderCode:240346348d647a73494-18318921%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec1e14f042dd6c0f1a276e6c9120e5fe4a0ac220' => 
    array (
      0 => 'application/views\\inap/ews.html',
      1 => 1665717829,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '240346348d647a73494-18318921',
  'function' => 
  array (
  ),
...
" class="active">Tindakan Keperawatan</a></li> -->
        ...
        <div class="content-entry">
            ...
            <tr>
                ...
                <td colspan="2">
                    <input name="TGL" type="text" size="10" maxlength="10" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FD_TGL_DICAPAI'])===null||$tmp==='' ? '' : $tmp);?>
...
?>
 ...
 <BR>
            <?php echo $_smarty_tpl->tpl_vars['data']->value['TGL'];?>
 <?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['data']->value['JAM'],'%H:%M');?>
           ...
           <br>
            <!-- <a    href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((((('inap/ews/edit/').($_smarty_tpl->tpl_vars['data']->value['id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['FS_KD_REG'])).('/')).($_smarty_tpl->tpl_vars['data']->value['FS_KD_TRS_KP']));?>
"  class="button-edit"    >    Edit</a   >  -->
              <a   href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((((('inap/ews/delete/').($_smarty_tpl->tpl_vars['data']->value['id'])).('/')).($_smarty_tpl->tpl_vars['data']->value['FS_KD_REG'])).('/')).($_smarty_tpl->tpl_vars['data']->value['FS_KD_TRS_KP']));?>
"   onclick="return confirm('Apakah Anda Yakin Akan Menghapus?');"    class="button-hapus"    >   Hapus</a  ><br />
