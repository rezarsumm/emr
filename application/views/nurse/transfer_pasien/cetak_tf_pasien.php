    ...
    <table class="content">
        ...
        <?php foreach ($rs_pasien as $pasien) { ?>
            ...
            <tr>
                ...
                <td style="border-top:solid 1px #000000;border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;"><?php echo $pasien['PEMERIKSAAN_FISIK1']; ?></td>
            </tr>
            <?php } ?>
        </tbody>
    </table>
...
<h5>IV. Derajat Kebutuhan Transfer</h5>
    <table class="content">
        <col style="width: 50%;font-size: 12px;">
        ...
        <tbody>
            ...
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;"><b>Derajat kebutuhan transfrer</b></td>
            ...
            <?php foreach ($rs_pasien as $pasien) { ?>
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">Derajat 0</td>
            ...
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">Derajat 1</td>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">
               
                <?php if($pasien['DERAJAT']=='1'){
                   echo 'ya';
               }else {
                   echo '';
               } ?>
            ...
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">Derajat 2</td>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">
               
                <?php if($pasien['DERAJAT']=='2'){
                   echo 'ya';
               }else {
                   echo '';
               } ?>
            ...
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">Derajat 3</td>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">
               
                <?php if($pasien['DERAJAT']=='3'){
                   echo 'ya';
               }else {
                   echo '';
               } ?>
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <?php foreach ($rs_pasien as $pasien) { ?>
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">TTV : <br><br> <?php echo $pasien['PEMERIKSAAN_FISIK1']; ?> </td>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;">TTV : <br><br> <?php echo $pasien['PEMERIKSAAN_FISIK2']; ?> </td>
  
            </tr>
            
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;">Catatan Penting : <br><br> <?php echo $pasien['CAT1']; ?> </td>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000;border-top:solid 1px #000000;border-right:solid 1px #000000;"></td>
