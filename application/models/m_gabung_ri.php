...
class m_gabung_ri extends CI_Model {
    ...
    function get_px_history($params) {
        $sql = "SELECT FD_TGL_MASUK,b.FS_KD_REG,FS_NM_PEG,FS_NM_LAYANAN,FS_STATUS,a.FS_MR 
                ...
                WHERE a.FS_STATUS = '1' AND a.FS_MR LIKE ? AND 
                b.FD_TGL_KELUAR='3000-01-01' AND b.FS_KD_JENIS_REG = '1' AND b.FD_TGL_VOID = '3000-01-01'";
