    ...
    <table class="content">
        ...
        <tr>
            <td align="center">
                ...
                NO <?= $rs_pasien['FS_KD_TRS']; ?>/RB/<?= date('m');?>/<?= date('Y');?>
            </td>
        </tr>
        </tbody>
    </table>
 ...
 <table class="content">
        ...
        <tbody>
            ...
            <tr>
                <td></td>
                <td align='center'>
                    <qrcode value="<?= $result['FS_KD_MEDIS']; ?> pada <?= $result['mdd']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
                    <br>
                </td>
            </tr>
            <tr>
