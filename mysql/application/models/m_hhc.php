...
class m_hhc extends CI_Model {
    ...
    function insert($params) {
        $sql = "INSERT INTO TAC_RI_HHC(FS_KD_REG, FS_PARAM_1, FS_PARAM_2, FS_PARAM_3, FS_PARAM_4,FS_PARAM_5,FS_PARAM_6,
                FS_PARAM_7, mdb, mdd_date, mdd_time)
                VALUES     (?,?,?,?,?,?,?,?,?,?,?)";
    ...
    function insert_evaluasi($params) {
        $sql = "INSERT INTO TAC_RI_HHC3(FS_KD_TRS_HHC,FS_NM_TINDAKAN,FS_NM_EVALUASI,mdb, mdd_date, mdd_time)
                VALUES (?,?,?,?,?,?)";
        return $this->db->query($sql, $params);
    }
