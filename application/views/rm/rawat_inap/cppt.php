            ...
            <tr>
                <td style="border-left:solid 1px #000000;border-bottom:solid 1px #000000; border-right:solid 1px #000000;">
                 ...
                 <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;" >
                   ...
                   if($z=='soap'){ echo "S";} else if($z=='sbar'){ echo "S";} else if($z=='adime'){ echo "A"; } else{ echo "S / S / A";} ?> : <?= strip_tags($cppt["FS_CPPT_S"]);?><br>
                   <?php 
                    if($z=='soap'){ echo "O";} else if($z=='sbar'){ echo "B";} else if($z=='adime'){ echo "D"; } else{ echo "O / B / D";} ?> : <?= strip_tags($cppt['FS_CPPT_O']);?><br>
                   
                   <?php 
                    if($z=='soap'){ echo "A";} else if($z=='sbar'){ echo "A";} else if($z=='adime'){ echo "I"; } else{ echo "A / A / I";} ?> : <?= strip_tags($cppt['FS_CPPT_A']);?><br>
                    
                    <?php 
                    if($z=='soap'){ echo "P";} else if($z=='sbar'){ echo "R";} else if($z=='adime'){ echo "ME"; } else{ echo "P / R / ME";} ?> : <?= strip_tags($cppt['FS_CPPT_P']);?><br>
                </td>
