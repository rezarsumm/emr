<?php /* Smarty version Smarty-3.0.7, created on 2022-06-30 11:48:20
         compiled from "application/views\inap/transfer_pasien/transfer.html" */ ?>
<?php /*%%SmartyHeaderCode:2167262bd2b14914c81-80755537%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d78c24a63ec028c5308a6a088143c60285f7710' => 
    array (
      0 => 'application/views\\inap/transfer_pasien/transfer.html',
      1 => 1655713264,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2167262bd2b14914c81-80755537',
  'function' => 
  array (
  ),
...
<div class="content-entry">
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/tf/transfer_process');?>
...
?>
                        <?php if ($_smarty_tpl->getVariable('medis')->value['MDB']==$_smarty_tpl->tpl_vars['data']->value['NAMAUSER']){?>
...
">  </td>
            ...
            <tr>
                <td>Keluhan Utama  </td>
                <td colspan="3"> <input type="text" name="ANAMNESA" style="width:78% ;" value="<?php echo $_smarty_tpl->getVariable('ases2')->value['FS_ANAMNESA'];?>
">  </td></tr>
                
             <tr>
                <td >Riwayat Penyakit </td>
                <td  ><input type="text" name="RIWAYAT_SAKIT" value="<?php echo $_smarty_tpl->getVariable('alergi')->value['FS_RIW_PENYAKIT_DAHULU'];?>
"  size="30"> </td>
                   <td> Riwayat  Alergi  </td>
                   <td> <input type="text" name="RIWAYAT_ALERGI_MAKANAN" value="<?php echo $_smarty_tpl->getVariable('alergi')->value['FS_ALERGI'];?>
" size="30">
            ...
            <tr>
                <td >Diagnosa Awal </td>
                <td  >
                   <input type="text" name="DIAGNOSA1" value="<?php echo $_smarty_tpl->getVariable('ases2')->value['DIAGNOSA'];?>
"  size="30"> </td>
                   <td> Diagnosa  Sekarang  </td>
                   <td>     <input type="text" name="DIAGNOSA2" value="<?php echo $_smarty_tpl->getVariable('ases2')->value['FS_DIAGNOSA'];?>
" size="30">      </td>
            </tr>
 ...
 $_from = $_smarty_tpl->getVariable('penunjang')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value){
?><?php echo $_smarty_tpl->tpl_vars['p']->value['FS_LAB'];?>
<?php }} ?> 
                        Radiologi    :  <?php  $_smarty_tpl->tpl_vars['p'] = new Smarty_Variable;
 $_from = $_smarty_tpl->getVariable('penunjang')->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value){
?><?php echo $_smarty_tpl->tpl_vars['p']->value['FS_RAD'];?>
<?php }} ?> 
                        Lain-lain    :
                        </textarea>
...
if ($_smarty_tpl->_count($_from) > 0){
    foreach ($_from as $_smarty_tpl->tpl_vars['p']->key => $_smarty_tpl->tpl_vars['p']->value){
?><?php echo $_smarty_tpl->tpl_vars['p']->value['FS_NAMA_OBAT'];?>
, <?php }} ?> 
                            </textarea>
                ...
                <TR>
                    <td colspan="2">
                        <textarea name="PEMERIKSAAN_FISIK1" rows="4" style="width:100%">
                            Kesadaran :                     | EWSS   :                | Suhu : <?php echo $_smarty_tpl->getVariable('vs')->value['FS_SUHU'];?>
C
                            Nadi      :  <?php echo $_smarty_tpl->getVariable('vs')->value['FS_NADI'];?>
x/menit         | R      :   <?php echo $_smarty_tpl->getVariable('vs')->value['FS_R'];?>
x/menit      | TD   :  <?php echo $_smarty_tpl->getVariable('vs')->value['FS_TD'];?>
MmHg
                            TB        : <?php echo $_smarty_tpl->getVariable('vs')->value['FS_TB'];?>
cm                 | BB     :  <?php echo $_smarty_tpl->getVariable('vs')->value['FS_BB'];?>
kg           | SPO2 :  %
                            GCS       :     |    E     :       |     V :     |     
                        </textarea>
                    </td>
