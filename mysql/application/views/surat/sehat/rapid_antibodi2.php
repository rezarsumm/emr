...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="page_header">
        <tr>
            <td style="width:100%;" >
                <img src="<?php base_url() ?>resource/doc/images/icon/koppku.png" width="750" height="120" />
            </td>
            ...
            <table class="content">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            : <?= $rs_surat['FS_TEMP_LAHIR']; ?>, <?= date('d F Y', strtotime($rs_surat['FD_TGL_LAHIR'])); ?>
                        </td>
                    ...
                    <tr>
                        <td colspan="2" align='justify'>
                            <br><br>
                            Telah dilakukan pemeriksaan <b>RAPID TEST ANTIGEN</b> dengan spesimen swab nasofaring yang diambil pada <br>tanggal <b><?= date('d F Y', strtotime($rs_surat['FD_TGL_TRS'])); ?></b> dengan hasil laboratorium sebagai berikut :
                            <br><br>
                            <table class="content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Waktu Sample</td>
                                        <td>
                                            : <?= date('d F Y', strtotime($rs_surat['FD_TGL_TRS'])); ?> <?= $rs_surat['FS_JAM_TRS'];?>
                                        </td>
        ...
        <table class="content">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <br>
                    <td></td>
                    <td align='center'>Yogyakarta, <?= date('d F Y', strtotime($rs_surat['FD_TGL_TRS'])); ?></td>
                </tr>
                <tr>
                    <td></td>
                    <td align='center'>
                       <br>
                        <img src="<?php base_url() ?>resource/doc/images/icon/cap_pku.png" width="70" height="70" />
