    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;">:</td>
                <td style="border-bottom:solid 1px #000000;"><?php if($rs_pasien['TGL_KELUAR']=='0000-00-00' || $rs_pasien['TGL_KELUAR']==''){echo date('d-M-Y', strtotime($rs_resume['FD_TGL_PULANG']));}else { echo date('d-M-Y', strtotime($rs_pasien['TGL_KELUAR'])); } ?></td>
