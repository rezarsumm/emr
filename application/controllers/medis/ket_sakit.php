...
class ket_sakit extends ApplicationBase {
...
// load model
  ...
  public function index() {
        ...
        // $this->smarty->assign("template_content", "medis/ket_sakit/index.html");
        $this->smarty->assign("template_content", "medis/ket_sakit/list.html");
        // load javascript
    ...
    public function cari_process() {
        ...
        //if ($cek == '0') {
        redirect("medis/ket_sakit/create_suratsakit/" . $FS_RG2);
        //} elseif ($cek == '1') {
    ...
    public function create_suratsakit($FS_KD_REG = "") { 
        ...
        if ($ceksuratsakit >= '1') {
           ...
           // set template content
                   $this->smarty->assign("template_content", "medis/ket_sakit/edit_suratsakit.html");
        ...
        // set page rules
                $this->_set_page_rule("R");
        // set template content
                $this->smarty->assign("template_content", "medis/ket_sakit/create_suratsakit.html");
                $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
                $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
                $this->smarty->load_javascript('resource/js/jquery/select2.js');
                $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
