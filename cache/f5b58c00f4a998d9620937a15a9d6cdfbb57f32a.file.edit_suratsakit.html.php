<?php /* Smarty version Smarty-3.0.7, created on 2022-03-17 09:56:18
         compiled from "application/views\medis/surat_sakit/edit_suratsakit.html" */ ?>
<?php /*%%SmartyHeaderCode:32996232a352b204a1-62563633%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5b58c00f4a998d9620937a15a9d6cdfbb57f32a' => 
    array (
      0 => 'application/views\\medis/surat_sakit/edit_suratsakit.html',
      1 => 1647398908,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32996232a352b204a1-62563633',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/surat_sakit/update_suratsakit');?>
" method="post">
...
" style="width: 400px;">
        ...
        <tr>
            ...
            <td > <input type="text" name="jumlahhari" onkeypress="return angka(event);"  value="<?php echo $_smarty_tpl->getVariable('ket_sakit')->value['JUMLAHHARI'];?>
" style="width: 400px;">
            </td>
        </tr>
        <tr><td> </td></tr>
