  ...
  <page_header>
    ...
    <table class="content" style="padding-top:10px">
        ...
        <tbody>
             ...
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 10px; background-color:white; text-align: center;"> </td>
                <td   style=" border: 2px  solid #000;background-color:lightgrey; padding:2px 5px;"> <?php   $t=$data['S_NAFAS']+ $data['S_O2']+ $data['S_AB']+$data['S_S']+$data['S_J']+$data['S_SADAR']; echo $t; ?></td>  
             <?php } ?> 
             </tr>
