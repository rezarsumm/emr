...
class cppt_new extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("template_content", "igd/cppt_igd/list.html");
        // load javascript
        ...
        $fs_kd_layanan = $this->com_user['fs_kd_layanan'];
                $this->smarty->assign("rs_pasien", $this->m_igd->get_pasien_ugd_cppt());
    ...
    public function cari2() {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "igd/cppt_igd/list_his.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
    ...
    public function cari_process() {
        ...
        redirect("igd/cppt_new/add/" . $FS_RG2);
        //} elseif ($cek == '1') {
        //redirect("igd/cppt_new/edit/" . $FS_RG2);
        // }
    }
    ...
    public function cari_process2() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            // insert
            redirect("igd/cppt_new/lists2/" . $this->input->post('FS_MR'));
        } else {
            // default error
            $this->tnotification->sent_notification("error", "Detail gagal disimpan");
        }
        // default redirect
        redirect("igd/cppt_new/cari2");
    }
    ...
    public function lists2($FS_MR = "") {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "igd/cppt_igd/list2.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
    ...
    public function add($FS_RG = '') {
        ...
        // set template content
        $this->smarty->assign("template_content", "igd/cppt_igd/add.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
    ...
    public function add_process() {
        ...
        // default redirect
        redirect("igd/cppt_new/add/" . $this->input->post('FS_KD_REG'));
    }
            ...
            if($x!='Dokter' && $this->input->post('TD')!=''){
                ...
                if($x!='Dokter' && $this->input->post('TD')!=''){
                    ...
                    if ($this->tnotification->run() !== FALSE) {
                            ...
                            // notification
                            $this->tnotification->delete_last_field();
                            $this->tnotification->sent_notification("success", "Detail berhasil di edit");
    ...
    public function delete_process() { 
        ...
        // process 
                            ...
                            // notification
                            $this->tnotification->delete_last_field();
                            $this->tnotification->sent_notification("success", "Detail berhasil dihapus");
    ...
    public function verif($FS_RG = "", $FS_KD_TRS = "") {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "igd/cppt_igd/verif.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
    ...
    public function edit($FS_KD_TRS='',$FS_RG = '') {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "igd/cppt_igd/edit.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
    ...
    public function delete($FS_KD_TRS='',$FS_RG = '') {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "igd/cppt_igd/delete.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
    ...
    //     // default redirect
    //     redirect("igd/cppt_new/add/" . $FS_KD_REG);
    // }
    ...
    public function cetak($FS_KD_REG = "") {
        ...
        ob_start();
        $this->load->view('igd/cppt_igd/print', $data);
