...
<page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
                        ...
                        <tbody>
                            <tr>
                                <td> <?php if ($rs_resume['FD_TGL_PULANG'] == '3000-01-01') { ?>
                                        ...
                                        echo date('d-M-Y', strtotime($rs_resume['FD_TGL_PULANG']));
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    <?php
                    if (empty($rs_resume['FD_TGL_KONTROL']) OR ($rs_resume['FD_TGL_KONTROL']=='3000-01-01')) {
                        echo '';
                    } else {
                        ?>
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <?php } ?>
             <tr>
                <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;border-bottom:solid 1px #000000;">Pemeriksaan Laboratorium</td>
                <td style="border-bottom:solid 1px #000000;">
                    <?php foreach ($rs_lab_resume as $lab) {
                            echo $lab['FS_NM_TARIF'].',';
                              } ?>
                </td>
                <td style="border-right:solid 1px #000000;border-bottom:solid 1px #000000;"></td>
            </tr>
                ...
                <tr>
                    ...
                    <td style="border-bottom:solid 1px #000000;">
                        <?php foreach ($rs_rad_resume as $rad) {
                            echo $rad['FS_NM_TARIF'].',';
                              } ?>
                    </td>
                    <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    </td>
