...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                <td colspan="2"> Hasil pemeriksaan laboratorium: <br><br></td>
            ...
            <tr>
                <td colspan="2" align='justify'>
                    <br><br>
                    Telah dilakukan pemeriksaan tes  <b>PCR (Polymerase Chain Reaction)  nCov 2019</b> 
                    dengan specimen swab nasofaring/orofaring yang diambil pada 
                    tanggal  <b> <?= date('d M Y', strtotime($rs_surat['FD_TGL_KET1'])); ?>  </b>
                    dengan hasil  <b><?= $rs_surat['FS_KETERANGAN1']; ?>  </b>, 
                    dengan demikian dinyatakan hasil swab <b><?= $rs_surat['FS_KETERANGAN2']; ?> </b>.
                    Hasil ini berlaku 14 (empat belas) hari setelah pemeriksaan terakhir.
                    <br><br>
