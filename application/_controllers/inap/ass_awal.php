...
class ass_awal extends ApplicationBase {
    ...
    public function index() {
        ...
        $this->smarty->assign("rs_pasien", $this->m_ass_awal->get_pasien_bangsal(array($date, $date2, $date, $date, $date, $date, $date, $date, $date, $date, $date)));
        // notification
    ...
    public function edit_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_ass_awal->update($params)) {
                ...
                $this->m_ass_awal->update_ases($params4);
...
// insert tujuan
    ...
    public function cetak_ass_awal($FS_KD_REG = "") {
        ...
        ob_start();
        $this->load->view('inap/ass_awal/print', $data);
