<?php /* Smarty version Smarty-3.0.7, created on 2021-03-15 15:51:02
         compiled from "application/views\inap/ass_awal/add_script_js.html" */ ?>
<?php /*%%SmartyHeaderCode:26550604f1ff63e2421-52851533%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68eadfd611d6c6b779d2eedcc312b05f3072cbad' => 
    array (
      0 => 'application/views\\inap/ass_awal/add_script_js.html',
      1 => 1608812796,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26550604f1ff63e2421-52851533',
  'function' => 
  array (
  ),
...
<script type="text/javascript">
    ...
    function score_sna() {
            ...
            $("#totalsna").html(sna);
            if (sna >= 1) {
                $("#kesimpulansna").html("Berisiko Malnutrisi");
            } else if (sna <= 0) {
                $("#kesimpulansna").html("Tidak Berisiko Malnutrisi");
            }
        }
