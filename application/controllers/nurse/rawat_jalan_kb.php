...
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "nurse/rawat_jalan_kb/history.html");
...
// insert tujuan
                ...
                $params7 = array(
                    ...
                    date('Y-m-d', strtotime($this->input->post('FS_RIW_MENS_HPM'))),
                    ...
                    $this->input->post('FS_HPHT'),
                    $this->input->post('FS_UK'),
                ...
                redirect("nurse/rawat_jalan_kb/history/".$this->input->post('NO')."/".$this->input->post('FS_KD_MEDIS')."");
            }
        } else {
            // default error
            $this->tnotification->sent_notification("error", "Detail gagal disimpan");
            redirect("nurse/rawat_jalan_kb/history/".$this->input->post('FS_MR')."/".$this->input->post('FS_KD_MEDIS')."");
        }
        // default redirect
