...
<?php foreach($covid as $data){ 

$result['rs_covid'] = $this->m_inap_covid->get_data_kontak(array($data['FS_KD_TRS']));    
$covid3 = $this->m_inap_covid->get_data_covid3_by_rg(array($data['FS_KD_TRS']));    
$covid4 = $this->m_inap_covid->get_data_covid4_by_rg(array($data['FS_KD_TRS']));    
$covid5 = $this->m_inap_covid->get_data_covid5_by_rg(array($data['FS_KD_TRS']));    
$covid6 = $this->m_inap_covid->get_data_covid6_by_rg(array($data['FS_KD_TRS']));    
$covid7 = $this->m_inap_covid->get_data_covid7_by_rg(array($data['FS_KD_TRS']));    
$covid8 = $this->m_inap_covid->get_data_covid8_by_rg(array($data['FS_KD_TRS']));    
?>
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    <?php
                        if ($data['FS_PARAM_1'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_1'] == '1') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                   <?php
                        if ($data['FS_PARAM_2'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_2'] == '2') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    <?php
                        if ($data['FS_PARAM_3'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_3'] == '3') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    <?php
                        if ($data['FS_PARAM_4'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_4'] == '4') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    <?php
                        if ($data['FS_PARAM_5'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_5'] == '5') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                    <?php
                        if ($data['FS_PARAM_6'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_6'] == '6') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-bottom:solid 1px #000000;border-right:solid 1px #000000;">
                   <?php
                        if ($data['FS_PARAM_7'] == '0') {
                            echo "Tidak";
                        } elseif ($data['FS_PARAM_7'] == '7') {
                            echo "Ya";
                        } else {
                            echo "-";
                        }
            ...
            <tr>
                ...
                <td style="border-right:solid 1px #000000;border-bottom:solid 1px #000000;text-align: right;" colspan="2">
                    Tanggal <?= $data['mdd']; ?>
                    <br><br>
        <qrcode value="<?= $data['FS_NM_PEG']; ?> pada <?= $data['mdd']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
        <br><br>
        <?= $data['FS_NM_PEG']; ?>
        </td>
        </tr>
...
<page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
    ...
    <table class="content">
        ...
        <col style="width: 33%;font-size: 10px;">
                        ...
                        <?php foreach ($result['rs_covid'] as $data2){?>
                        <tr>
                            <td style="border:solid 1px #000000;text-align: center;"><?= $data2['FS_NM_KONTAK'];?></td>
                            <td style="border:solid 1px #000000;text-align: center;"><?= $data2['FS_NM_DOMISILI'];?></td>
                            <td style="border:solid 1px #000000;text-align: center;"><?= $data2['FS_NO_HP'];?></td>
                        </tr>
                        <?php } ?>
                    </table>
                </td>
