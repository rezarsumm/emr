...
<div class="box box-solid">
    <div class="box-header with-border">
        <h3 class="box-title">Cari Data Layanan</h3>
    </div>
...
<div class="box box-solid">
    ...
    <div class="box-body">
        <div id="toolbarGrid">
            <a href="<?php echo site_url('content/admin/layanan/add'); ?>" class="btn btn-info"><i class="fa fa-plus-circle"></i> Tambah Baru</a>
        </div>
        <table id="tableDataPage" width="100%"
            data-toolbar="#toolbarGrid"
            data-pagination="true"
            data-show-refresh="true"
            data-url="<?php echo site_url('content/admin/layanan/load_data_page'); ?>"
        >
            <thead>
                <tr>
...
var linkAksi = function(value,row,index){
    var htmlAksi = '';
    htmlAksi += '<a href="<?php echo site_url('content/admin/layanan/edit/'); ?>'+value+'" class="btn btn-xs btn-info btn-flat">EDIT</a> ';
...
var labelPost = function(value,row,index){
    if(value == 'welcome_message'){
        return '<span class="text-primary">Layanan Selamat Datang</span>';
    }
    if(value == 'none'){
...
var doDeletePage = function(pageId)
{
    ...
    function(){
        $.post("<?php echo site_url('content/admin/layanan/delete/');?>",{pageId:pageId},function(response){
