...
// get search parameter
        ...
        $this->smarty->assign("rs_pasien", $this->m_rawat_jalan_nurse->get_px_history(array($now, $medis, $medis, $medis, $FS_MR)));
...
// output
    ...
    public function add_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_rawat_jalan->insert($params)) {
                ...
                $params6 = array(
                    ...
                    '',
                    $this->input->post('FS_NM_KET_INTERVENSI'),
                    '',
                    $this->com_user['user_id'],
                    date('Y-m-d')
                );
                $this->m_rawat_jalan_nurse->insert_fisio($params6);
                ...
                $this->m_rawat_jalan->insert_tac_rj_medis($params);
        ...
        // default redirect
        if ($this->input->post('FS_CARA_PULANG') == '1') {
            if ($cekskdp >= '1') {
                redirect("nurse/fisio/edit_rb/" . $this->input->post('FS_KD_REG'));
            } elseif ($this->input->post('FS_CARA_PULANG') == '1' && $cekskdp == '0') {
                redirect("nurse/fisio/add_rb/" . $this->input->post('FS_KD_REG'));
            } else {
                redirect("nurse/fisio/");
            }
        } elseif ($this->input->post('FS_CARA_PULANG') == '2') {
            if ($cekskdp >= '1') {
                redirect("nurse/fisio/edit_skdp/" . $this->input->post('FS_KD_REG'));
            } elseif ($this->input->post('FS_CARA_PULANG') == '2' && $cekskdp == '0') {
                redirect("nurse/fisio/add_skdp/" . $this->input->post('FS_KD_REG'));
            } else {
                redirect("nurse/fisio/");
            }
        } elseif ($this->input->post('FS_CARA_PULANG') == '4') {
            if ($cekskdp >= '1') {
                redirect("nurse/fisio/edit_konsul/" . $this->input->post('FS_KD_REG'));
            } elseif ($this->input->post('FS_CARA_PULANG') == '4' && $cekskdp == '0') {
                redirect("nurse/fisio/add_konsul/" . $this->input->post('FS_KD_REG'));
            } else {
                redirect("nurse/fisio/");
            }
        } else {
...
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "nurse/fisio/add_skdp.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
...
// set page rules
        $this->_set_page_rule("U");
// set template content
        $this->smarty->assign("template_content", "nurse/fisio/edit_skdp.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
        ...
        $this->smarty->assign("result", $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($now, $FS_KD_REG)));
        $this->smarty->assign("rs_skdp_alasan", $this->m_rawat_jalan->get_tac_com_parameter_alasan());
        $this->smarty->assign("skdp", $this->m_rawat_jalan->get_data_skdp_by_rg(array($FS_KD_REG)));
// notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
// output
    ...
    public function add_rb($FS_KD_REG = "") {
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "nurse/fisio/add_rb.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
...
// output
    ...
    public function add_rb_process() {
        // set page rules
        $this->_set_page_rule("C");
        // cek input
        $this->tnotification->set_rules('FS_KD_REG', 'KODE REGISTER', 'trim|required');
    ...
    public function edit_rb($FS_KD_REG = "") {
// set page rules
        $this->_set_page_rule("U");
// set template content
        $this->smarty->assign("template_content", "nurse/fisio/edit_rb.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
...
// output
    ...
    public function edit_rb_process() {
        // set page rules
        $this->_set_page_rule("U");
        // cek input
        $this->tnotification->set_rules('FS_KD_REG', 'KODE TRANSAKSI', 'trim|required');
    ...
    public function add_konsul($FS_KD_REG = "") {
// set page rules
        $this->_set_page_rule("R");
// set template content
        $this->smarty->assign("template_content", "nurse/fisio/add_konsul.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
...
// output
    ...
    public function add_konsul_process() {
        // set page rules
        $this->_set_page_rule("C");
        // cek input
        $this->tnotification->set_rules('FS_KD_REG', 'KODE REGISTER', 'trim|required');
    ...
    public function edit_konsul($FS_KD_REG = "") {
// set page rules
        $this->_set_page_rule("U");
// set template content
        $this->smarty->assign("template_content", "nurse/fisio/edit_konsul.html");
        // load javascript    
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/tinymce/tinymce.min.js');
...
// output
    ...
    public function edit_konsul_process() {
        // set page rules
        $this->_set_page_rule("U");
        // cek input
        $this->tnotification->set_rules('FS_KD_REG', 'KODE TRANSAKSI', 'trim|required');
    ...
    public function cetak_prb($FS_KD_REG = "", $FS_KD_TRS = "") {
        ...
        ob_start();
        $this->load->view('nurse/fisio/prb', $data);
    ...
    public function cetak_konsul($FS_KD_REG = "", $FS_KD_TRS = "") {
        $this->_set_page_rule("R");
        $this->load->library('html2pdf');
        $now = date('Y-m-d');
        $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($now, $FS_KD_REG));
        $data['rs_skdp'] = $this->m_rawat_jalan_nurse->get_data_skdp_by_rg(array($FS_KD_REG));
        $data["result"] = $this->m_rawat_jalan->get_data_medis_by_rg2(array($FS_KD_REG, $FS_KD_TRS));
        $data["header1"] = $this->m_rawat_jalan->get_header1();
        $data["header2"] = $this->m_rawat_jalan->get_header2();
        $data["alamat"] = $this->m_rawat_jalan->get_alamat();
        ob_start();
        $this->load->view('nurse/fisio/konsul', $data);
        $content = ob_get_contents();
        ob_end_clean();
    ...
    public function cetak_selesai($FS_KD_REG = "", $FS_KD_TRS = "") {
        $this->_set_page_rule("R");
        $this->load->library('html2pdf');
        $now = date('Y-m-d');
        $data['rs_pasien'] = $this->m_rawat_jalan->get_px_by_dokter_by_rg2(array($now, $FS_KD_REG));
        ...
        $data["alamat"] = $this->m_rawat_jalan->get_alamat();
        ob_start();
        $this->load->view('nurse/fisio/selesai', $data);
        $content = ob_get_contents();
        ob_end_clean();
