...
// load javascript
        ...
        // $FD_TGL_MASUK = '2021-05-22';
        // search parameters

        // if($this->com_user['user_name']=='216'|| $this->com_user['user_name']=='217' || $this->com_user['user_name']=='215' || $this->com_user['user_name']=='213'|| $this->com_user['user_name']=='202'){
        //     $FS_KD_PEG='100';
        // }
        // else{
...
// get search parameter
        ...
        if($x=='216'|| $x=='217' || $x=='211' || $x=='215'|| $x=='213'|| $x=='202' || $x=='219' || $x=='220' || $x=='221' || $x=='312' || $x=='222' || $x=='223'){
       ...
       $medis = $this->com_user['user_name'];
        ...
        if($konsul=='x'){
            ...
            $this->smarty->assign("noww", $skrng);
             ...
             if($x=='216'|| $x=='217'|| $x=='215'|| $x=='213'|| $x=='202' || $x=='219' || $x=='220' || $x=='221' || $x=='312'  || $x=='222'  || $x=='223'){
