...
class inacbg52 {
    ...
    function UpdateDataKlaim($nomor_sep, $nomor_kartu, $tgl_masuk, $tgl_pulang, $jenis_rawat, $kelas_rawat, $adl_sub_acute, $adl_chronic, $icu_indikator, $icu_los, $ventilator_hour, $upgrade_class_ind, $upgrade_class_class, $upgrade_class_los, $add_payment_pct, $birth_weight, $discharge_status, $diagnosa, $procedure, $tarif_rs_non_bed, $tarif_rs_bed, $tarif_rs_konsul, $tarif_rs_ahli, $tarif_rs_perawat, $tarif_rs_penunjang, $tarif_rs_radiologi, $tarif_rs_lab, $tarif_rs_darah, $tarif_rs_rehab, $tarif_rs_kamar, $tarif_rs_obat, $tarif_rs_alkes, $tarif_rs_bmhp, $tarif_rs_sewa, $tarif_poli_eks, $nama_dokter, $kode_tarif, $payor_id, $payor_cd, $cob_cd, $coder_nik, $FS_KD_REG) {
        $request = '{
                        "metadata": {
                        ...
                        "data": {
                            ...
                            "procedure": "' . $procedure . '",
                           "tarif_rs": {
                                "prosedur_non_bedah": "' . $tarif_rs_non_bed . '",
                                "prosedur_bedah": "' . $tarif_rs_bed . '",
                                "konsultasi": "' . $tarif_rs_konsul . '",
                                "tenaga_ahli": "' . $tarif_rs_ahli . '",
                                "keperawatan": "' . $tarif_rs_perawat . '",
                                "penunjang": "' . $tarif_rs_penunjang . '",
                                "radiologi": "' . $tarif_rs_radiologi . '",
                                "laboratorium": "' . $tarif_rs_lab . '",
                                "pelayanan_darah": "' . $tarif_rs_darah . '",
                                "rehabilitasi": "' . $tarif_rs_rehab . '",
                                "kamar": "' . $tarif_rs_kamar . '",
                                "rawat_intensif": "0",
                                "obat": "' . $tarif_rs_obat . '",
                                "alkes": "' . $tarif_rs_alkes . '",
                                "bmhp": "' . $tarif_rs_bmhp . '",
                                "sewa_alat": "' . $tarif_rs_sewa . '"
                                },
