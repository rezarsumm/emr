...
<div class="row">
	<?php 
		$hidden_form = array(
			"inputTypePost" => "layanan",
			"inputAuthor" => $user_id,
			"inputContentId" => $page_id
		);
		echo form_open_multipart("content/admin/layanan/save", array("method" => "post","id" => "formInputPage"), $hidden_form); 
	?>
		<div class="col-md-8">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						$inputJudulPage = array(
							...
							"value" 		=> set_value("inputJudulPage",$page->pageTitle)
						);
					...
					<div class="form-group">
						...
						$inputMetaTagPage = array(
							...
							"value" 		=> set_value("inputMetaTagPage",$page->pageMetaTags)
						);
					...
					<div class="form-group">
						...
						$inputMetaDeskripsiPage = array(
							...
							"value" 		=> set_value("inputMetaDeskripsiPage",$page->pageMetaDescription)
						);
				...
				<div class="box-body">
					<div class="form-group">
						<div class="text-center">
							<div id="idImagePage">
								<?php if($page->pageImage): ?>
									<img src="<?php echo _URL . $page->pageImage; ?>" width="300">
								<?php endif; ?>
							</div><br>
					  ...
					  <input type="hidden" name="inputImagePage" id="inputImagePage" value="<?php echo $page->pageImage; ?>">
					</div>
				</div>
			</div>
				...
				<div class="box-body">
						...
						<div class="input-group date" id="datetimepicker">
							<?php
								$inputTanggalPage = array(
									...
									"id" 			=> "inputTanggalPage",
									"class" 		=> "form-control",
									"value" 		=> set_value("inputTanggalPage",$page->pageCreated)
								);
					...
					<div class="form-group">
						...
						$inputStatusPage = array(
							"id" 			=> "inputStatusPage",
							"class" 		=> "form-control",
							"placeholder" 	=> "Kategori Page",
						);
						echo form_label("Status : ");
						echo form_dropdown("inputStatusPage",$status_page,set_value("inputStatusPage",$page->pageStatus),$inputStatusPage);
						?>
					</div>
					<div class="form-group">
						<?php
						...
						echo form_label("Status : ");
						echo form_dropdown("inputLabelPage",$label_page,set_value("inputLabelPage",$page->pageLabel),$inputLabelPage);
						?>
					</div>
				</div>
...
$(document).ready(function(){
	...
	$('#inputIsiPage').val('<?php echo preg_replace( "/\r|\n/", "",$page->pageText); ?>');
});
...
tinymce.init({
   ...
   setup: function (editor) {
        ...
        //editor.setContent($('#inputIsiPage').html());
    }
 });
