  ...
  <br>
    ...
    <table class="content" style="font-size:12px; padding-top:0px; width:700px" >
        ...
        <col style="width: 50%;font-size: 12px;">
         ...
         <tr>
            <td  >Tanggal Operasi </td><td> : <?= date("d-m-Y", strtotime($h['TGL_OP']));?></td></tr> 
        <tr>
            <td >  Jam Operasi  </td> <td> : <?= date("H:i", strtotime($rs_lap_op['JAM_MULAI']));?> - <?= date("H:i", strtotime($rs_lap_op['JAM_SELESAI']));?> </td> </tr>
       <tr>  <td >  Dokter Operator  </td> <td> : <?= $rs_lap_op['NAMALENGKAP'];?></td>  </tr>
       <tr>   <td >  Dokter Anestesi  </td> <td> : <?= $rs_lap_anes['NAMALENGKAP'];?></td> </tr>
    ...
    <table  >
             ...
             <?php    $juml=substr_count($h['namabarang'],"\n");
                    ...
                    for($a=0; $a<$juml; $a++){ 
                        ...
                        $jumlah=explode("=",$pecah[$a]);
                        
                        $hitung_isi=strlen($jumlah[0]);
                        if($jumlah[0]!='\n' || $jumlah[0]!=' \n' || $jumlah[0]!='\n ' || $jumlah[0]!=' \n'){
