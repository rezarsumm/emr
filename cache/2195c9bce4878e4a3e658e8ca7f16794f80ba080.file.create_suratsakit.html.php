<?php /* Smarty version Smarty-3.0.7, created on 2022-03-16 16:53:05
         compiled from "application/views\medis/surat_sakit/create_suratsakit.html" */ ?>
<?php /*%%SmartyHeaderCode:100626231b38172e493-98554107%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2195c9bce4878e4a3e658e8ca7f16794f80ba080' => 
    array (
      0 => 'application/views\\medis/surat_sakit/create_suratsakit.html',
      1 => 1647398902,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '100626231b38172e493-98554107',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/surat_sakit/simpan_suratsakit');?>
" method="post">
...
" />
    ...
    <table class="table-input" width="80%">
        ...
        <tr>
            ...
            <td > <input type="date" name="tglmulai"  value="<?php echo $_smarty_tpl->getVariable('now')->value;?>
" style="width: 400px;">
            </td>
        </tr>
        <tr>
            ...
            <td > <input type="text" name="jumlahhari" onkeypress="return angka(event);" style="width: 400px;">
            </td>
        </tr>
        <tr><td> </td></tr>
