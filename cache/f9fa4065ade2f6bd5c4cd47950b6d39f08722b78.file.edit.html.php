<?php /* Smarty version Smarty-3.0.7, created on 2022-02-03 15:32:01
         compiled from "application/views\medis/rawat_inap/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:473661fb930139b0b9-06751267%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f9fa4065ade2f6bd5c4cd47950b6d39f08722b78' => 
    array (
      0 => 'application/views\\medis/rawat_inap/edit.html',
      1 => 1643877040,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '473661fb930139b0b9-06751267',
  'function' => 
  array (
  ),
...
<form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('medis/rawat_inap/edit_process');?>
...
" />
    ...
    <table class="table-input" width="100%">
        ...
        <tr>  
            <td colspan="2">
                <textarea cols="50" rows="4" name="FS_ANAMNESA"><?php echo $_smarty_tpl->getVariable('result')->value['FS_ANAMNESA'];?>
</textarea>
            </td>
            <td colspan="2">
                <textarea cols="50"  rows="4" name="FS_CATATAN_FISIK"><?php echo $_smarty_tpl->getVariable('result')->value['FS_CATATAN_FISIK'];?>
</textarea>
        ...
        <tr>
            <td colspan="2">
                <textarea cols="50" rows="4" name="FS_HASIL_PEMERIKSAAN_PENUNJANG"><?php echo $_smarty_tpl->getVariable('result')->value['FS_HASIL_PEMERIKSAAN_PENUNJANG'];?>
</textarea>
            </td>
            <td colspan="2">
                <textarea cols="50" rows="4" name="FS_DIAGNOSA"><?php echo $_smarty_tpl->getVariable('result')->value['FS_DIAGNOSA'];?>
</textarea>
        ...
        <tr>
            <td colspan="2">
                <textarea cols="50" rows="4" name="FS_DAFTAR_MASALAH"><?php echo $_smarty_tpl->getVariable('result')->value['FS_DAFTAR_MASALAH'];?>
</textarea>
            </td>
            <td colspan="2">
                <textarea cols="50" rows="4" name="FS_TINDAKAN"><?php echo $_smarty_tpl->getVariable('result')->value['FS_TINDAKAN'];?>
</textarea>
        ...
        <tr>
            <td colspan="2">
                ...
                <select name="FS_PLANNING_LAB[]" multiple id="rlab" style="width:350px">
                    ...
                    <?php }else{ ?>
                <textarea cols="50" name="FS_PLANNING_LAB"><?php echo $_smarty_tpl->getVariable('result')->value['FS_PLANNING_LAB'];?>
</textarea>
                <?php }?>
...
" class="inilablama" >
            ...
            <td colspan="2">
                 <?php if ($_smarty_tpl->getVariable('result')->value['FS_PLANNING_RAD']=='0'||$_smarty_tpl->getVariable('result')->value['FS_PLANNING_RAD']==''){?>
                  <select name="FS_PLANNING_RAD[]" multiple id="rrad" style="width:350px">
                    ...
                    <?php }else{ ?>
                <textarea cols="50" name="FS_PLANNING_RAD"><?php echo $_smarty_tpl->getVariable('result')->value['FS_PLANNING_RAD'];?>
</textarea>
                <?php }?>
        ...
        <tr>
            ...
            <td colspan="2">
               <!--  <textarea cols="50" rows="8" name="FS_TERAPI"><?php echo $_smarty_tpl->getVariable('result')->value['FS_TERAPI'];?>
</textarea> -->
            ...
            <td colspan="2">
                 ...
                 <textarea rows="5" cols="50" name="FS_PESAN"><?php echo $_smarty_tpl->getVariable('result')->value['FS_PESAN'];?>
