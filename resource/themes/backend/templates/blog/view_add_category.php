...
<div class="box box-solid">
	...
	<div class="box-body">
		<?php 
			$hidden_form = array("inputAuthor" => $user_id);
			...
			<div class="col-sm-9">
				<?php
					$inputNamaKategori = array(
						...
						"value" 		=> set_value("inputNamaKategori")
					);
			...
			<div class="col-sm-9">
				<?php
					$inputKategoriMetaTags = array(
						...
						"value" 		=> set_value("inputKategoriMetaTags")
					);
			...
			<div class="col-sm-9">
				<?php
					$inputKategoriMetaDeskripsi = array(
						...
						"rows"			=> 2,
						"value" 		=> set_value("inputKategoriMetaDeskripsi")
					);
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<?php
					...
					echo form_dropdown("inputKategoriStatus",$status_category,set_value("inputKategoriStatus"),$inputKategoriStatus);
				?>
			</div>
		</div>
