...
<page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
  <page_header>
    ...
    <table class="content" style="padding-top:10px">
        ...
        <tbody>
             <tr>
             <td rowspan="3" style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">Tanda Tanda Vital </td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">Tgl </td> 
             <?php  foreach($result as $data){ ?> 
                <td   style=" border: 2px  solid #000; padding:2px 5px;  background-color:white ;"> <?php echo date('d-m-Y', strtotime($data['TGL'])); ?></td>
             ...
             <tr>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">Frekuensi </td> 
             <?php  foreach($result as $data){ ?> 
                <td  style=" border: 2px  solid #000; padding:2px 5px ;  background-color:white;"> <?php echo $data['FREKUENSI']; ?>  </td>
             ...
             <tr>
             <td  style=" border: 1px  solid #000; padding:10px 10px; background-color:white; text-align: center;">Respirasi </td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:white; text-align: center;"> </td>
                 
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_NAFAS'];?>"> <?php echo $data['NAFAS']; ?></td>   
             <?php } ?> 
             </tr>
             ...
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_O2'];?>"> <?php echo $data['O2']; ?></td>   
             <?php } ?> 
             </tr>
             ...
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_AB'];?>"> <?php echo $data['AB']; ?></td>   
             <?php } ?> 
             </tr>
             ...
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_S'];?>"> <?php echo $data['S']; ?></td>   
             <?php } ?> 
             </tr>
             ...
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_J'];?>"> <?php echo $data['J']; ?></td>   
             <?php } ?> 
             </tr>
             ...
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_TD'];?>"> <?php echo $data['TD']; ?></td>   
             <?php } ?> 
             </tr>


             <tr>
             <td style=" border: 1px  solid #000; padding:10px 10px; background-color:white; text-align: center;">TD Diastol </td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:white; text-align: center;"> </td>
                 
             <?php  foreach($result as $data){ ?> 
                <td style=" border: 1px  solid #000; padding:2px 5px; background-color:<?= $data['S_D'];?>"> <?php echo $data['D']; ?></td>   
             <?php } ?> 
             </tr>
             ...
             <?php  foreach($result as $data){ ?> 
                <td colspan="1" style=" border: 1px  solid #000; padding:2px 5px;">  
