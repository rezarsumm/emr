				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						$inputJudulArtikel = array(
							...
							"value" 		=> set_value("inputJudulArtikel")
						);
					...
					<div class="form-group">
						...
						echo form_dropdown("inputIdCategoryArtikel",$categories,set_value("inputIdCategoryArtikel"),$inputIdCategoryArtikel);
						?>
					 </div>
					<div class="form-group">
					  	<?php 
					...
					<div class="form-group">
						...
						$inputMetaTagArtikel = array(
							...
							"value" 		=> set_value("inputMetaTagArtikel")
						);
					...
					<div class="form-group">
						...
						$inputMetaDeskripsiArtikel = array(
							...
							"value" 		=> set_value("inputMetaDeskripsiArtikel")
						);
			...
			<div class="box box-solid">
				...
				<div class="box-body">
					<div class="form-group">
					  ...
					  <input type="hidden" name="inputImageArtikel" id="inputImageArtikel" value="">
					</div>
				</div>
			</div>
			...
			<div class="box box-solid">
				...
				<div class="box-body">
						...
						<div class="input-group date" id="datetimepicker">
							<?php
								$inputTanggalArtikel = array(
									...
									"class" 		=> "form-control",
									"value" 		=> set_value("inputTanggalArtikel",date('d-m-Y H:i:s'))
								);
					...
					<div class="form-group">
						...
						echo form_dropdown("inputStatusArtikel",$status_artikel,set_value("inputStatusArtikel"),$inputStatusArtikel);
						?>
					</div>
				</div>
