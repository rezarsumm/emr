...
// get search parameter
        ...
        //$this->smarty->assign("rs_pasien2", $this->m_igd->get_px_by_dokter_wait(array($now,$FS_KD_PEG)));
        //$this->smarty->assign("rs_pasien3", $this->m_igd->get_px_by_dokter_wait_farmasi(array($now,$FS_KD_PEG)));
// notification
    ...
    public function add_process() {
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_igd->insert_tac_rj_medis($params)) {
                ...
                $cekskdp = $this->m_igd->get_cek_skdp(array($this->input->post('FS_KD_REG')));
                /* $params2 = array(
                  $NOKP,
                  $this->input->post('FS_KD_REG'),
                  $this->input->post('FS_DIAGNOSA'),
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            if ($this->m_igd->update_tac_rj_medis($params)) {
                ...
                /* $params2 = array(
                  ...
                  $this->m_igd->update_tac_rj_medis($params2); */
                $params8 = array(
                    $this->input->post('FS_HIGH_RISK'),
                    $this->input->post('FS_MR')
                );
