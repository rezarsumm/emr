...
<tr>
    ...
    <td style="border-right:solid 1px #000000;border-bottom:solid 1px #000000;text-align: center;">
        ...
        <br><br>
        <barcode type="C39" value="<?= $vs['NAMALENGKAP'];?>" style="width:30mm; height:6mm; font-size: 1mm"></barcode>
        <br><br>
        <?= $vs['NAMALENGKAP']; ?>
    </td>
</tr>
    ...
    <table class="page_header">
        <tr>
            ...
            <td style="width:45%;" valign="top">
                Nama : <?php echo $rs_pasien['NAMA_PASIEN']; ?><br>
                No MR : <?php echo $rs_pasien['NO_MR']; ?><br>
                Tgl Lahir : <?php echo date('d-M-Y', strtotime($rs_pasien['TANGGAL'])); ?>
            </td>
        </tr>
    </table>
    </page_header>
        ...
        <tbody>
            ...
            <tr>
                <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;border-bottom:solid 1px #000000;text-align: right; ">
                    ...
                    <br><br>
                    <barcode type="C39" value="<?= $result['NAMALENGKAP'];?>" style="width:30mm; height:6mm; font-size: 1mm"></barcode>
                    <br><br>
                    <?= $result['NAMALENGKAP']; ?>
                </td>
            </tr>
