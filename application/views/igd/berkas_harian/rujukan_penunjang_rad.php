...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        ...
        <tr>
            <td align="center" rowspan="4">
                <b>PERMINTAAN PEMERIKSAAN PENUNJANG RADIOLOGI</b>
            </td>
        </tr>
         <tr>
        ...
        <tr>
            <td><br>Tanggal Lahir : <?= date('d-m-Y',  strtotime($rs_pasien['TGL_LAHIR'])); ?></td>
        ...
        <tr>
            <td colspan="2"><br><br>Alamat : <?= $rs_pasien['ALAMAT']; ?></td>
        </tr>
        </tbody>
    </table>
    <hr>
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2"><br><b>KETERANGAN KLINIK PENDERITA</b></td>
            </tr>
             <tr>
                <td>Diagnosa</td>
                <td>
 ...
 <table class="content">
        ...
        <tbody> 
            <tr>
                 ...
                 <br>
                <td></td>
                <td align='center'><?= $alamat['pref_value'];?>, <?= $rs_pasien['MDD']; ?></td>
            </tr>
            <tr>
                <td></td>
                <?php
               ...
               if($cekk==true){
                ...
                ?>
                <td align='center'>
                    <qrcode value="<?= $sejawat ?> pada <?= $rs_pasien['MDD']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
                    <br>
                </td>
            </tr>
            <tr>
