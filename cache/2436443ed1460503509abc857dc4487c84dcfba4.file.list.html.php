<?php /* Smarty version Smarty-3.0.7, created on 2021-09-24 15:06:22
         compiled from "application/views\pengaturan/operator/list.html" */ ?>
<?php /*%%SmartyHeaderCode:19846606e757276a9e5-94813500%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19846606e757276a9e5-94813500',
  'function' => 
  array (
  ),
...
.</td>
            ...
            <td><?php echo (($tmp = @((mb_detect_encoding($_smarty_tpl->tpl_vars['result']->value['NamaLengkap'], 'UTF-8, ISO-8859-1') === 'UTF-8') ? mb_strtoupper($_smarty_tpl->tpl_vars['result']->value['NamaLengkap'],SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->tpl_vars['result']->value['NamaLengkap'])))===null||$tmp==='' ? '-' : $tmp);?>
</td>
            <td align="center"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['FS_HP_PEG'])===null||$tmp==='' ? '-' : $tmp);?>
</td>
            <td align="center"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['Nama_Bangsal'])===null||$tmp==='' ? '-' : $tmp);?>
</td>
