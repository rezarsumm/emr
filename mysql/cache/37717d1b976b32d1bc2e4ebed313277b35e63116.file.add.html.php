<?php /* Smarty version Smarty-3.0.7, created on 2021-03-16 11:04:59
         compiled from "application/views\inap/resume/add.html" */ ?>
<?php /*%%SmartyHeaderCode:3192960502e6b69e066-25458653%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '3192960502e6b69e066-25458653',
  'function' => 
  array (
  ),
...
<div class="head-content">
    <div class="head-content-nav">
        <ul>
            <li><a href="<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('inap/resume/add/').($_smarty_tpl->getVariable('rs_pasien')->value['fs_kd_reg']));?>
 ...
 / <?php echo $_smarty_tpl->getVariable('rs_pasien')->value['FS_NM_PENDIDIKAN_DK'];?>
        ...
        <table class="table-input" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="FS_KELUHAN_UTAMA" rows="3" cols="100"><?php echo $_smarty_tpl->getVariable('rs_pasien')->value['fs_anamnese'];?>
</textarea>
                </td>
            </tr>
            <tr>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    Suhu : <input type="text" name="FS_SUHU1" size="10">
                    Nadi : <input type="text" name="FS_NADI1" size="10">x/menit
                    R : <input type="text" name="FS_R1" size="10">x/menit
                    TD : <input type="text" name="FS_TD1" size="10">mmHg
                </td>
            </tr>
            <tr>
...
,<?php }} ?></textarea>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type='checkbox' name='FS_INSTRUKSI5'  value="YA">Hubungi (0274)6499118 IGD RS PKU Muhammadiyah Gamping bila dalam keadaan gawat darurat<br>   
                </td>
            </tr>
            <tr>
                <td>
...
?>
                        <option value="<?php echo $_smarty_tpl->tpl_vars['data']->value['FS_KD_LAYANAN'];?>
"><?php echo $_smarty_tpl->tpl_vars['data']->value['FS_NM_LAYANAN'];?>
</option>
                        <?php }} ?>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input name="FD_TGL_KONTROL" type="text" size="10" maxlength="10" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FD_TGL_UND'])===null||$tmp==='' ? '' : $tmp);?>
...
" size="10" maxlength="10" style="text-align: center"/>
            ...
            <tr>
                ...
                <td>
                    <input name="FS_KET_KONTROL" type="text" value="DI RS PKU MUH GAMPING" size="25" />
                </td>
            </tr>
            <tr>
                <td>
...
?>
                        <option value="<?php echo $_smarty_tpl->tpl_vars['data2']->value['FS_KD_LAYANAN'];?>
"><?php echo $_smarty_tpl->tpl_vars['data2']->value['FS_NM_LAYANAN'];?>
</option>
                        <?php }} ?>
                    </select>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input name="FD_TGL_KONTROL2" type="text" size="10" maxlength="10" value="<?php echo (($tmp = @$_smarty_tpl->getVariable('result')->value['FD_TGL_UND2'])===null||$tmp==='' ? '' : $tmp);?>
" class="tanggal" style="text-align: center;" />
                </td>
            </tr>
            <tr>
...
" size="10" maxlength="10" style="text-align: center"/>
            ...
            <tr>
                ...
                <td>
                    <input name="FS_KET_KONTROL2" type="text" value="DI RS PKU MUH GAMPING" size="25"/>
                </td>
            </tr>
            <tr>
