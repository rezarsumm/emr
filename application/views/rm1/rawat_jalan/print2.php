...
<page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
        ...
        <table class="page_header">
            <tr>
                ...
                <td style="width:45%;" valign="top">
                    Nama : <?php echo $rs_pasien['NAMAPASIEN']; ?><br>
                    No MR : <?php echo $rs_pasien['NOPASIEN']; ?><br>
                    Tgl Lahir : <?php echo date('d-M-Y', strtotime($rs_pasien['TGLLAHIR'])); ?>
                </td>
            </tr>
        </table>
    </page_header>
    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    : <?php echo date('d-M-Y', strtotime($rs_pasien['TGL_REG'])); ?>
                </td>
                <td>Klinik Tujuan</td>
            ...
            <tr>
                ...
                <td style="border-right:solid 1px #000000;border-bottom:solid 1px #000000;">
                    : <b>
                        <?php
                        if ($alergi['FS_ALERGI'] == '1') {
                            echo "Belum Diketahui";
                        } elseif ($alergi['FS_ALERGI'] == '2') {
                            echo "Tidak Ada";
                        } elseif ($alergi['FS_ALERGI'] == '3') {
                            echo "<b>Ada, " . $alergi['FS_ALERGI2'] . "</b>";
                        } else {
                            echo"-";
                        }
                            ?>
    ...
    <page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
        ...
        <table class="content">
            ...
            <tbody>
                <tr>
                    <td style="font-size: 12px;border-bottom:solid 1px #000000;" colspan="2"><b>ASESMEN GIZI</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>A</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($gizi['FS_GIZI_A']); ?></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>D</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($gizi['FS_GIZI_D']); ?></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>I</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($gizi['FS_GIZI_I']); ?></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;" colspan="2"><b>ME</b></td>
                </tr>
                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;"><?= strip_tags($gizi['FS_GIZI_ME']); ?></td>
                </tr>

                <tr>
                    <td style="border-left:solid 1px #000000;border-right:solid 1px #000000;border-bottom:solid 1px #000000;text-align: right; ">
                        Tanggal <?= $gizi['mdd_date']; ?> Jam <?= $gizi['mdd_time']; ?><br>
                        <br><br>
            <barcode type="C39" value="<?= $gizi['mdb']; ?>" style="width:30mm; height:6mm; font-size: 1mm"></barcode>
            <br><br>
            <?= $gizi['FS_NM_PEG']; ?>
            </td>
            </tr>
