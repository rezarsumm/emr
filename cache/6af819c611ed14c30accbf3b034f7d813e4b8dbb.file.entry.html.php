<?php /* Smarty version Smarty-3.0.7, created on 2022-07-26 09:41:56
         compiled from "application/views\nurse/rencana_op/entry.html" */ ?>
<?php /*%%SmartyHeaderCode:1817262df54740214c7-04446743%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6af819c611ed14c30accbf3b034f7d813e4b8dbb' => 
    array (
      0 => 'application/views\\nurse/rencana_op/entry.html',
      1 => 1658113272,
      2 => 'file',
  ...
  'nocache_hash' => '1817262df54740214c7-04446743',
  'function' => 
  array (
  ),
...
<div class="content-entry">
    ...
    <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('nurse/rencana_op/entry_process');?>
...
">
            ...
            <tr>
                ...
                <td width="20%">
                    <input type="text" name="DIAGNOSA" <?php if ($_smarty_tpl->getVariable('rs_umum_pra')->value['DIAGNOSA']==''){?>  value="<?php echo $_smarty_tpl->getVariable('medis')->value['FS_DIAGNOSA'];?>
...
"  class="form-control">
                ...
                <td width="20%">
                    <input type="checkbox" name="LAMPIRAN[]" value="Asesmen Pra Bedah" value="<?php echo $_smarty_tpl->getVariable('rs_umum_pra')->value['LAMPIRAN'];?>
" checked class="form-control">Asesmen Pra Bedah<br>
                    <input type="checkbox" name="LAMPIRAN[]" value="Edukasi Anestesi" value="<?php echo $_smarty_tpl->getVariable('rs_umum_pra')->value['LAMPIRAN'];?>
" checked class="form-control">Edukasi Anestesi<br>
                    <input type="checkbox" name="LAMPIRAN[]" value="Informed Consent Bedah" value="<?php echo $_smarty_tpl->getVariable('rs_umum_pra')->value['LAMPIRAN'];?>
...
<tr class="submit-box">
                <td colspan="5">
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('medis/rawat_nurse/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-green">Asesmen Awal Medis Rawat Inap</a>
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/ass_awal/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-red2">Asesmen Awal Keperawatan</a>
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/ass_jatuh/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-blue2">Asesmen Jatuh</a>
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/kep/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-green2">Rencana dan Tindakan Keperawatan</a>
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/rm10/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-orange">Catatan Edukasi</a>
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/rm17/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-pink">Catatan Pemberian Obat</a>
                    <!--<a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/dp/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
...
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-yellow">Rekonsiliasi Obat</a>
                    -->
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(('nurse/resume/cari_process_cppt/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG']));?>
', 'nama_window_pop_up', 'width=1000,height=1000,scrollbars=yes,resizeable=no')" class="btn-red">Resume Pasien Pulang</a>
                    ...
                    <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url((('rm/rawat_nurse/cetak_rm/').($_smarty_tpl->getVariable('rs_pasien')->value['NO_REG'])).('/10'));?>
...
?>
    <tr>
        <td><?php echo $_smarty_tpl->tpl_vars['cppt']->value['TGL'];?>
            ...
            <a href="javascript:void(0);" onclick="window.open('<?php echo $_smarty_tpl->getVariable('config')->value->site_url(((('rm/rawat_nurse/cetak_data_umum_pra/').($_smarty_tpl->tpl_vars['cppt']->value['FS_KD_REG'])).('/')).($_smarty_tpl->tpl_vars['cppt']->value['id']));?>
