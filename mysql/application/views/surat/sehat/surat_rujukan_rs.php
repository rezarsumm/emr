...
<page orientation="P" backtop="15mm" backbottom="10mm" backleft="15mm" backright="10mm" style="font-size:9pt">
    ...
    <table class="content">
        ...
        <tr>
            ...
            <td>
                : <?= $rs_surat['FS_TEMP_LAHIR']; ?>, <?= $rs_surat['FD_TGL_LAHIR']; ?>
            </td>
        ...
        <tr>
            <td>Jenis Kelamin</td>
            <td>
                : <?php if($rs_surat['FS_JNS_KELAMIN'] == '0'){
                echo "Laki-laki";
            }else{
            echo "Perempuan";
        } ?>
...
<tr>
    <td>Diagnosa</td>
    <td>
        : <?= strip_tags($diagnosa['FS_DIAGNOSA']); ?>
    </td>
...
<table class="content">
    ...
    <tbody>
        ...
        <tr>
         ...
         <br>
         <td></td>
         <td align='center'><?= $alamat['pref_value'];?>, <?= $rs_surat['FD_TGL_TRS']; ?></td>
     </tr>
     <tr>
    ...
    <tr>
        <td></td>
        <td align='center'>
           <qrcode value="<?= $rs_surat['FS_KD_MEDIS'];?> <?= $rs_surat['FD_TGL_TRS']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
           <br>
       </td>
   </tr>
   <tr>
