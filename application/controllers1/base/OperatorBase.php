...
class ApplicationBase extends CI_Controller {
    ...
    private function _display_sidebar_navigation() {
        ...
        if($x=='216'|| $x=='217'|| $x=='215'|| $x=='213'|| $x=='202' || $x=='219' || $x=='223' || $x=='220' || $x=='221' || $x=='222' || $x=='312'){
                $html .='<li><a class="parent" href="'. site_url('medis/suratt').'"> <img src="' . base_url() . 'resource/doc/images/nav/135.png' . '" alt="" /> Surat Sakit/SKD</a></li>';
                ...
                $html .='<li><a class="parent" href="'. site_url('medis/surat_sakit').'"> <img src="' . base_url() . 'resource/doc/images/nav/135.png' . '" alt="" /> Surat Ket Sakit</a></li>';
                 if($x=='121' || $x=='133'){
