<?php /* Smarty version Smarty-3.0.7, created on 2022-02-18 09:34:31
         compiled from "application/views\inap/ass_awal_bidan/hamil.html" */ ?>
<?php /*%%SmartyHeaderCode:26291620f05b794e309-89510430%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5400b93a22d566799ab00d35804703ef7823370d' => 
    array (
      0 => 'application/views\\inap/ass_awal_bidan/hamil.html',
      1 => 1645090016,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26291620f05b794e309-89510430',
  'function' => 
  array (
  ),
...
<div id="ModalAdd">
    <div class="modal-dialog">
        <div class="modal-content">
           <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/ass_awal_bidan/add_process_hamil');?>
" method="post">
                <input type="hidden" name="FS_KD_REG" value="<?php echo $_smarty_tpl->getVariable('rs_pasien')->value['NO_REG'];?>
" />
                <input type="hidden" name="FS_MR" value="<?php echo $_smarty_tpl->getVariable('rs_pasien')->value['NO_MR'];?>
...
<div id="ModalHapus">
    <table class="table-input" width="100%">
        ...
        <tr>
        <form action="<?php echo $_smarty_tpl->getVariable('config')->value->site_url('inap/ass_awal_bidan/hapus_anak');?>
" method="post">
                <input type="hidden" name="FS_KD_REG" value="<?php echo $_smarty_tpl->getVariable('rs_pasien')->value['NO_REG'];?>
" />
                <input type="hidden" name="FS_MR" value="<?php echo $_smarty_tpl->getVariable('rs_pasien')->value['NO_MR'];?>
