...
<page backtop="27mm" backbottom="10mm" backleft="2mm" backright="2mm" style="font-size:10pt">
  <page_header>
    ...
    <table class="content">
        ...
        <tr>
            <td align="center">
                <br><strong>LEMBAR OBSERVASI EARLY WARNING SCORE</strong>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="content" style="padding-top:10px">
        ...
        <tbody>
             <tr>
             <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">No</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">Nafas</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> O2</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> Alat Bantu</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> Suhu</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> Jantung</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> TD Sistolik</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> Kesadaran</td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;"> Total </td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">Waktu </td>
                 <td style=" border: 1px  solid #000; padding:2px 10px; background-color:lightgrey; text-align: center;">Petugas </td>
            </tr>
            <?php $no=1;
    ...
    <tr> 
         ...
         <td style=" border: 1px  solid #000; padding:2px 5px;"> <?php echo $no++; ?></td>  
         ...
         <td style=" border: 1px  solid #000; padding:2px 5px;"> <?php   $t=$data['S_NAFAS']+ $data['S_O2']+ $data['S_AB']+$data['S_S']+$data['S_J']+$data['S_SADAR']; echo $t; ?></td> 
         <td style=" border: 1px  solid #000; padding:2px 5px;"> <?php echo $data['TGL']; ?> <?php echo date('H:i', strtotime($data['JAM'])); ?>  </td>
         <td style=" border: 1px  solid #000; padding:2px 5px;"> <?php echo $data['MDB']; ?>    </td>
