               ...
               $params4 = array(
                ...
                $riwayat= array (
                    ...
                    $this->input->post('FS_ANAMNESA_0'),
                     $this->input->post('FS_HAID_MEN_0'),
                     $this->input->post('FS_HAID_SIKLUS_0'),
                     $this->input->post('FS_HAID_LAMA_0'),
                     $this->input->post('FS_HAID_HPHT_0'),
                     $this->input->post('FS_HAID_HPL_0'),
                     $this->input->post('FS_HAID_KELUHAN_0'),
                     $this->input->post('FS_STATUS_PERKAWINAN_0'),
                     $this->input->post('FS_LAMA_MENIKAH_0'),
                     $this->input->post('RIWAYAT_KEHAMILAN_0'),
                     $this->input->post('FS_ASMA_MULAI_0'),
                     $this->input->post('FS_ASMA_TERAPI_0'),
                     $this->input->post('FS_JANTUNG_MULAI_0'),
                     $this->input->post('FS_JANTUNG_TERAPI_0'),
                     $this->input->post('FS_DIABETES_MULAI_0'),
                     $this->input->post('FS_DIABETES_TERAPI_0'),
                     $this->input->post('FS_HIPERTENSI_MULAI_0'),
                     $this->input->post('FS_HIPERTENSI_TERAPI_0'),
                     $this->input->post('FS_SAKIT_LAIN_0'),
                     $this->input->post('FS_RIWAYAT_GYNEKOLOGI_0'),
                     $this->input->post('FS_RIWAYAT_KB_0'),
                     $this->input->post('FS_RIWAYAT_KOMPLIKASI_KB_0'),
                     $this->input->post('POLA_MAKAN_0'),
                     $this->input->post('POLA_MINUM_0'),
                     $this->input->post('POLA_BAK_0'),
                     $this->input->post('POLA_BAB_0'),
                     $this->input->post('JAM_TERAKHIR_MAKAN_0'),
                     $this->input->post('JAM_TERAKHIR_MINUM_0'),
                     $this->input->post('JAM_TERAKHIR_BAK_0'),
                     $this->input->post('JAM_TERAKHIR_BAB_0'),
                    //  $this->input->post('RUMAH_MILIK_0'),
                    //  $this->input->post('TINGGAL_BERSAMA_0'),
                    //  $this->input->post('PJ_DARURAT_0'),
                    //  $this->input->post('HUBUNGAN_PJ_0'),
                    //  $this->input->post('AKTIFITAS_0'),
                    //  $this->input->post('SOSIAL_SUPPORT_0'),
                    '',
                    '',
                    '',
                    '',
                    ...
                    '',
                    '',
                    //  $this->input->post('PENERIAMAAN_PERSALINAN_0'),
                     $this->input->post('KEADAAN_UMUM_0'),
                     $this->input->post('ALAT_BANTU_0'),
                     $this->input->post('MATA_0'),
                     $this->input->post('KEPALA_0'),
                     $this->input->post('TELINGA_0'),
                     $this->input->post('HIDUNG_0'),
                     $this->input->post('TENGGOROKAN_0'),
                     $this->input->post('LEHER_0'),
                     $this->input->post('DADA_0'),
                     $this->input->post('JANTUNG_0'),
                     $this->input->post('PARU_PARU_0'),
                     $this->input->post('ABDOMEN_0'),
                     $this->input->post('BADAN_GERAK_ATAS_0'),
                     $this->input->post('BADAN_GERAK_BAWAH_0'),
                     $this->input->post('SCLERA_0'),
                     $this->input->post('KONJUNGTIVA_0'),
                     $this->input->post('CEK_DADA_0'),
                     $this->input->post('INSPEKSI_ABDOMEN_0'),
                     $this->input->post('LEOPOD_1_0'),
                     $this->input->post('LEOPOD_2_0'),
                     $this->input->post('LEOPOD_3_0'),
                     $this->input->post('LEOPOD_4_0'),
                     $this->input->post('AUSKULTASI_0'),
                     $this->input->post('KONTRAKSI_0'),
                     $this->input->post('INSPEKSI_ANO_GENITAS_0'),
                     $this->input->post('VAGINA_TOUCHER_0'),
                     $this->input->post('MASALAH_KEBIDANAN_0'),
                     $this->input->post('DIAGNOSA_0'),
                     $this->input->post('NAMA_SUAMI_0'),
                     $this->input->post('TGL_LAHIR_SUAMI_0'),
                     $this->input->post('AGAMA_SUAMI_0'),
                     $this->input->post('PENDIDIKAN_SUAMI_0'),
                     $this->input->post('JOB_SUAMI_0'),
                ...
                $this->m_rawat_jalan->insert_riwayat_ases_bidan($riwayat);
