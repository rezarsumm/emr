...
class Rencana_op extends ApplicationBase {
    ...
    public function index() {
        ...
        // set template content
                $this->smarty->assign("template_content", "nurse/rencana_op/index.html");
        ...
        // load javascript
                ...
                $fs_kd_layanan = $this->com_user['fs_kd_layanan'];
                 $this->smarty->assign("rs_pasien", $this->m_igd->get_px_op_poli(array($fs_kd_layanan)));           
    ...
    public function cari_proses() {
        ...
        if ($cek == '0') {
           $rolenya=$this->com_user['role_name'];
             redirect("nurse/rencana_op/add/" . $FS_RG2);
        } elseif ($cek >= '1') {
         redirect("nurse/rencana_op/edit/" . $FS_RG2);
        }
    }
    ...
    public function transfer() {
        ...
        // set template content
        $this->smarty->assign("template_content", "nurse/rencana_op/transfer.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
    ...
    public function entry($FS_RG = '',$idoperasi='') {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "nurse/rencana_op/entry.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
        ...
        $this->smarty->assign("alergi", $this->m_ass_awal->get_data_alergi_by_rg(array($FS_RG)));
         ...
         $rolenya=$this->com_user['role_nm'];
          ...
          $this->smarty->assign("medis", $this->m_igd->get_data_medis_by_rg2(array($FS_RG, $FS_KD_TRS)));
    ...
    public function add() {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "nurse/rencana_op/add.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
        ...
        $fs_kd_layanan = $this->com_user['fs_kd_layanan'];
            ...
            $this->smarty->assign("rs_pasien_bangsal", $this->m_igd->get_px_poli());
            $this->smarty->assign("rs_pasien", $this->m_igd->get_px_op_poli(array($fs_kd_layanan)));           
    ...
    public function edit($id='') {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "nurse/rencana_op/edit.html");
        // load javascript
        $this->smarty->load_javascript("resource/js/jquery/jquery-ui-1.9.2.custom.min.js");
        $this->smarty->load_javascript('resource/js/jquery/select2.js');
        $this->smarty->load_javascript('resource/js/jquery/jquery-ui-timepicker-addon.js');
