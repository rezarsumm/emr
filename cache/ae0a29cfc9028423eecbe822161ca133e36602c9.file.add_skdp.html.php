<?php /* Smarty version Smarty-3.0.7, created on 2022-03-15 09:47:18
         compiled from "application/views\medis/rawat_jalan/add_skdp.html" */ ?>
<?php /*%%SmartyHeaderCode:32749622ffe365ee455-07969946%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ae0a29cfc9028423eecbe822161ca133e36602c9' => 
    array (
      0 => 'application/views\\medis/rawat_jalan/add_skdp.html',
      1 => 1647312436,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32749622ffe365ee455-07969946',
  'function' => 
  array (
  ),
...
"><?php echo $_smarty_tpl->tpl_vars['skdp_alasan']->value['FS_NM_SKDP_ALASAN'];?>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="FS_SKDP_FASKES" class="tanggal" value=" <?php if ($_smarty_tpl->getVariable('ases2')->value['FS_SKDP_FASKES']=='1900-01-01'){?> <?php }else{ ?> <?php echo $_smarty_tpl->getVariable('ases2')->value['FS_SKDP_FASKES'];?>
 <?php }?>" size="10"/>
            </td>
        </tr>
        <tr>
